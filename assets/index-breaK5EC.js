...
`,ma=64,ha=ma*ma,ga=new Float32Array(ha);for(let e=0;e<ha;e++)ga[e]=e;`${fa}`,`${pa}`,`${pa}${fa}${ua.toFixed(4)}${da.toFixed(4)}`,`${pa}`;var _a=`#version 300 es
precision highp float;
in vec2 uvContent;
out vec4 outColor;
uniform sampler2D src;
