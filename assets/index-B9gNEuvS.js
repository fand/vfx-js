...
`].filter(Zi).join(`
`)),o=ka(o),o=ol(o,t),o=ll(o,t),a=ka(a),a=ol(a,t),a=ll(a,t),o=cl(o),a=cl(a),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
 ...
 * @namespace
 * @public
 */var t=function(n){var r=/(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,s=0,o={},a={manual:n.Prism&&n.Prism.manual,disableWorkerMessageHandler:n.Prism&&n.Prism.disableWorkerMessageHandler,util:{encode:function y(S){return S instanceof l?new l(S.type,y(S.content),S.alias):Array.isArray(S)?S.map(y):S.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/\u00a0/g," ")},type:function(y){return Object.prototype.toString.call(y).slice(8,-1)},objId:function(y){return y.__id||Object.defineProperty(y,"__id",{value:++s}),y.__id},clone:function y(S,x){x=x||{};var R,b;switch(a.util.type(S)){case"Object":if(b=a.util.objId(S),x[b])return x[b];R={},x[b]=R;for(var w in S)S.hasOwnProperty(w)&&(R[w]=y(S[w],x));return R;case"Array":return b=a.util.objId(S),x[b]?x[b]:(R=[],x[b]=R,S.forEach(function(D,E){R[E]=y(D,x)}),R);default:return S}},getLanguage:function(y){for(;y;){var S=r.exec(y.className);if(S)return S[1].toLowerCase();y=y.parentElement}return"none"},setLanguage:function(y,S){y.className=y.className.replace(RegExp(r,"gi"),""),y.classList.add("language-"+S)},currentScript:function(){if(typeof document>"u")return null;if(document.currentScript&&document.currentScript.tagName==="SCRIPT")return document.currentScript;try{throw new Error}catch(R){var y=(/at [^(\r\n]*\((.*):[^:]+:[^:]+\)$/i.exec(R.stack)||[])[1];if(y){var S=document.getElementsByTagName("script");for(var x in S)if(S[x].src==y)return S[x]}return null}},isActive:function(y,S,x){for(var R="no-"+S;y;){var b=y.classList;if(b.contains(S))return!0;if(b.contains(R))return!1;y=y.parentElement}return!!x}},languages:{plain:o,plaintext:o,text:o,txt:o,extend:function(y,S){var x=a.util.clone(a.languages[y]);for(var R in S)x[R]=S[R];return x},insertBefore:function(y,S,x,R){R=R||a.languages;var b=R[y],w={};for(var D in b)if(b.hasOwnProperty(D)){if(D==S)for(var E in x)x.hasOwnProperty(E)&&(w[E]=x[E]);x.hasOwnProperty(D)||(w[D]=b[D])}var M=R[y];return R[y]=w,a.languages.DFS(a.languages,function(C,G){G===M&&C!=y&&(this[C]=w)}),w},DFS:function y(S,x,R,b){b=b||{};var w=a.util.objId;for(var D in S)if(S.hasOwnProperty(D)){x.call(S,D,S[D],R||D);var E=S[D],M=a.util.type(E);M==="Object"&&!b[w(E)]?(b[w(E)]=!0,y(E,x,null,b)):M==="Array"&&!b[w(E)]&&(b[w(E)]=!0,y(E,x,D,b))}}},plugins:{},highlightAll:function(y,S){a.highlightAllUnder(document,y,S)},highlightAllUnder:function(y,S,x){var R={callback:x,container:y,selector:'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};a.hooks.run("before-highlightall",R),R.elements=Array.prototype.slice.apply(R.container.querySelectorAll(R.selector)),a.hooks.run("before-all-elements-highlight",R);for(var b=0,w;w=R.elements[b++];)a.highlightElement(w,S===!0,R.callback)},highlightElement:function(y,S,x){var R=a.util.getLanguage(y),b=a.languages[R];a.util.setLanguage(y,R);var w=y.parentElement;w&&w.nodeName.toLowerCase()==="pre"&&a.util.setLanguage(w,R);var D=y.textContent,E={element:y,language:R,grammar:b,code:D};function M(G){E.highlightedCode=G,a.hooks.run("before-insert",E),E.element.innerHTML=E.highlightedCode,a.hooks.run("after-highlight",E),a.hooks.run("complete",E),x&&x.call(E.element)}if(a.hooks.run("before-sanity-check",E),w=E.element.parentElement,w&&w.nodeName.toLowerCase()==="pre"&&!w.hasAttribute("tabindex")&&w.setAttribute("tabindex","0"),!E.code){a.hooks.run("complete",E),x&&x.call(E.element);return}if(a.hooks.run("before-highlight",E),!E.grammar){M(a.util.encode(E.code));return}if(S&&n.Worker){var C=new Worker(a.filename);C.onmessage=function(G){M(G.data)},C.postMessage(JSON.stringify({language:E.language,code:E.code,immediateClose:!0}))}else M(a.highlight(E.code,E.grammar,E.language))},highlight:function(y,S,x){var R={code:y,grammar:S,language:x};if(a.hooks.run("before-tokenize",R),!R.grammar)throw new Error('The language "'+R.language+'" has no grammar.');return R.tokens=a.tokenize(R.code,R.grammar),a.hooks.run("after-tokenize",R),l.stringify(a.util.encode(R.tokens),R.language)},tokenize:function(y,S){var x=S.rest;if(x){for(var R in x)S[R]=x[R];delete S.rest}var b=new d;return h(b,b.head,y),c(y,b,S,b.head,0),_(b)},hooks:{all:{},add:function(y,S){var x=a.hooks.all;x[y]=x[y]||[],x[y].push(S)},run:function(y,S){var x=a.hooks.all[y];if(!(!x||!x.length))for(var R=0,b;b=x[R++];)b(S)}},Token:l};n.Prism=a;function l(y,S,x,R){this.type=y,this.content=S,this.alias=x,this.length=(R||"").length|0}l.stringify=function y(S,x){if(typeof S=="string")return S;if(Array.isArray(S)){var R="";return S.forEach(function(M){R+=y(M,x)}),R}var b={type:S.type,content:y(S.content,x),tag:"span",classes:["token",S.type],attributes:{},language:x},w=S.alias;w&&(Array.isArray(w)?Array.prototype.push.apply(b.classes,w):b.classes.push(w)),a.hooks.run("wrap",b);var D="";for(var E in b.attributes)D+=" "+E+'="'+(b.attributes[E]||"").replace(/"/g,"&quot;")+'"';return"<"+b.tag+' class="'+b.classes.join(" ")+'"'+D+">"+b.content+"</"+b.tag+">"};function u(y,S,x,R){y.lastIndex=S;var b=y.exec(x);if(b&&R&&b[1]){var w=b[1].length;b.index+=w,b[0]=b[0].slice(w)}return b}function c(y,S,x,R,b,w){for(var D in x)if(!(!x.hasOwnProperty(D)||!x[D])){var E=x[D];E=Array.isArray(E)?E:[E];for(var M=0;M<E.length;++M){if(w&&w.cause==D+","+M)return;var C=E[M],G=C.inside,N=!!C.lookbehind,H=!!C.greedy,K=C.alias;if(H&&!C.pattern.global){var X=C.pattern.toString().match(/[imsuy]*$/)[0];C.pattern=RegExp(C.pattern.source,X+"g")}for(var Q=C.pattern||C,O=R.next,ie=b;O!==S.tail&&!(w&&ie>=w.reach);ie+=O.value.length,O=O.next){var ae=O.value;if(S.length>y.length)return;if(!(ae instanceof l)){var ge=1,Te;if(H){if(Te=u(Q,ie,y,N),!Te||Te.index>=y.length)break;var _e=Te.index,We=Te.index+Te[0].length,W=ie;for(W+=O.value.length;_e>=W;)O=O.next,W+=O.value.length;if(W-=O.value.length,ie=W,O.value instanceof l)continue;for(var ee=O;ee!==S.tail&&(W<We||typeof ee.value=="string");ee=ee.next)ge++,W+=ee.value.length;ge--,ae=y.slice(ie,W),Te.index-=ie}else if(Te=u(Q,0,ae,N),!Te)continue;var _e=Te.index,oe=Te[0],xe=ae.slice(0,_e),Ge=ae.slice(_e+oe.length),be=ie+ae.length;w&&be>w.reach&&(w.reach=be);var Qe=O.prev;xe&&(Qe=h(S,Qe,xe),ie+=xe.length),m(S,Qe,ge);var it=new l(D,G?a.tokenize(oe,G):oe,K,oe);if(O=h(S,Qe,it),Ge&&h(S,O,Ge),ge>1){var Be={cause:D+","+M,reach:be};c(y,S,x,O.prev,ie,Be),w&&Be.reach>w.reach&&(w.reach=Be.reach)}}}}}}function d(){var y={value:null,prev:null,next:null},S={value:null,prev:y,next:null};y.next=S,this.head=y,this.tail=S,this.length=0}function h(y,S,x){var R=S.next,b={value:x,prev:S,next:R};return S.next=b,R.prev=b,y.length++,b}function m(y,S,x){for(var R=S.next,b=0;b<x&&R!==y.tail;b++)R=R.next;S.next=R,R.prev=S,y.length-=b}function _(y){for(var S=[],x=y.head.next;x!==y.tail;)S.push(x.value),x=x.next;return S}if(!n.document)return n.addEventListener&&(a.disableWorkerMessageHandler||n.addEventListener("message",function(y){var S=JSON.parse(y.data),x=S.language,R=S.code,b=S.immediateClose;n.postMessage(a.highlight(R,a.languages[x],x)),b&&n.close()},!1)),a;var v=a.util.currentScript();v&&(a.filename=v.src,v.hasAttribute("data-manual")&&(a.manual=!0));function p(){a.manual||a.highlightAll()}if(!a.manual){var f=document.readyState;f==="loading"||f==="interactive"&&v&&v.defer?document.addEventListener("DOMContentLoaded",p):window.requestAnimationFrame?window.requestAnimationFrame(p):window.setTimeout(p,16)}return a}(e);i.exports&&(i.exports=t),typeof Tl<"u"&&(Tl.Prism=t),t.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},t.languages.markup.tag.inside["attr-value"].inside.entity=t.languages.markup.entity,t.languages.markup.doctype.inside["internal-subset"].inside=t.languages.markup,t.hooks.add("wrap",function(n){n.type==="entity"&&(n.attributes.title=n.content.replace(/&amp;/,"&"))}),Object.defineProperty(t.languages.markup.tag,"addInlined",{value:function(r,s){var o={};o["language-"+s]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:t.languages[s]},o.cdata=/^<!\[CDATA\[|\]\]>$/i;var a={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:o}};a["language-"+s]={pattern:/[\s\S]+/,inside:t.languages[s]};var l={};l[r]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,function(){return r}),"i"),lookbehind:!0,greedy:!0,inside:a},t.languages.insertBefore("markup","cdata",l)}}),Object.defineProperty(t.languages.markup.tag,"addAttribute",{value:function(n,r){t.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+n+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[r,"language-"+r],inside:t.languages[r]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),t.languages.html=t.languages.markup,t.languages.mathml=t.languages.markup,t.languages.svg=t.languages.markup,t.languages.xml=t.languages.extend("markup",{}),t.languages.ssml=t.languages.xml,t.languages.atom=t.languages.xml,t.languages.rss=t.languages.xml,function(n){var r=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;n.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+r.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+r.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+r.source+"$"),alias:"url"}}},selector:{pattern:RegExp(`(^|[{}\\s])[^{}\\s](?:[^{};"'\\s]|\\s+(?![\\s{])|`+r.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:r,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},n.languages.css.atrule.inside.rest=n.languages.css;var s=n.languages.markup;s&&(s.tag.addInlined("style","css"),s.tag.addAttribute("style","css"))}(t),t.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},t.languages.javascript=t.languages.extend("clike",{"class-name":[t.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+(/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source)+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),t.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,t.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:t.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:t.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:t.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:t.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:t.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),t.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:t.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),t.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),t.languages.markup&&(t.languages.markup.tag.addInlined("script","javascript"),t.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),t.languages.js=t.languages.javascript,function(){if(typeof t>"u"||typeof document>"u")return;Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var n="Loading…",r=function(v,p){return"✖ Error "+v+" while fetching file: "+p},s="✖ Error: File does not exist or is empty",o={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},a="data-src-status",l="loading",u="loaded",c="failed",d="pre[data-src]:not(["+a+'="'+u+'"]):not(['+a+'="'+l+'"])';function h(v,p,f){var y=new XMLHttpRequest;y.open("GET",v,!0),y.onreadystatechange=function(){y.readyState==4&&(y.status<400&&y.responseText?p(y.responseText):y.status>=400?f(r(y.status,y.statusText)):f(s))},y.send(null)}function m(v){var p=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(v||"");if(p){var f=Number(p[1]),y=p[2],S=p[3];return y?S?[f,Number(S)]:[f,void 0]:[f,f]}}t.hooks.add("before-highlightall",function(v){v.selector+=", "+d}),t.hooks.add("before-sanity-check",function(v){var p=v.element;if(p.matches(d)){v.code="",p.setAttribute(a,l);var f=p.appendChild(document.createElement("CODE"));f.textContent=n;var y=p.getAttribute("data-src"),S=v.language;if(S==="none"){var x=(/\.(\w+)$/.exec(y)||[,"none"])[1];S=o[x]||x}t.util.setLanguage(f,S),t.util.setLanguage(p,S);var R=t.plugins.autoloader;R&&R.loadLanguages(S),h(y,function(b){p.setAttribute(a,u);var w=m(p.getAttribute("data-range"));if(w){var D=b.split(/\r\n?|\n/g),E=w[0],M=w[1]==null?D.length:w[1];E<0&&(E+=D.length),E=Math.max(0,Math.min(E-1,D.length)),M<0&&(M+=D.length),M=Math.max(0,Math.min(M,D.length)),b=D.slice(E,M).join(`
`),p.hasAttribute("data-start")||p.setAttribute("data-start",String(E+1))}f.textContent=b,t.highlightElement(f)},function(b){p.setAttribute(a,c),f.textContent=b})}}),t.plugins.fileHighlight={highlight:function(p){for(var f=(p||document).querySelectorAll(d),y=0,S;S=f[y++];)t.highlightElement(S)}};var _=!1;t.fileHighlight=function(){_||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),_=!0),t.plugins.fileHighlight.highlight.apply(this,arguments)}}()}(na)),na.exports}var dg=fg();const xc=ug(dg);xc.manual=!0;xc.highlightAll();function cn(i,e){return(e??document).querySelector(i)}function wl(i,e,t){return i*(1-t)+e*t}const bi={logo:`
    precision highp float;
    uniform vec2 resolution;
    uniform vec2 offset;
    uniform float time;
