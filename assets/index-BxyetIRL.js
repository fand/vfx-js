...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function Qa(){return new hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ua(),fragmentShader:`
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function eo(){return new hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ua(),fragmentShader:`
...
`)+`
`+f);const _=S+p+o,v=S+f+a,R=lo(r,r.VERTEX_SHADER,_),b=lo(r,r.FRAGMENT_SHADER,v);r.attachShader(y,R),r.attachShader(y,b),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(C){if(i.debug.checkShaderErrors){const H=r.getProgramInfoLog(y).trim(),z=r.getShaderInfoLog(R).trim(),G=r.getShaderInfoLog(b).trim();let Y=!0,W=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,y,R,b);else{const j=uo(r,R,"vertex"),N=uo(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
Program Info Log: `+H+`
`+j+`
`+N)}else H!==""?console.warn("THREE.WebGLProgram: Program Info Log:",H):(z===""||G==="")&&(W=!1);W&&(C.diagnostics={runnable:Y,programLog:H,vertexShader:{log:z,prefix:p},fragmentShader:{log:G,prefix:f}})}r.deleteShader(R),r.deleteShader(b),D=new vr(r,y),T=Jh(r,y)}let D;this.getUniforms=function(){return D===void 0&&A(this),D};let T;this.getAttributes=function(){return T===void 0&&A(this),T};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=r.getProgramParameter(y,kh)),M},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Wh++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=R,this.fragmentShader=b,this}let up=0;class fp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new dp(e),t.set(e,n)),n}}class dp{constructor(e){this.id=up++,this.code=e,this.usedTimes=0}}function hp(i,e,t,n,r,s,o){const a=new Yo,l=new fp,c=new Set,u=[],d=r.logarithmicDepthBuffer,h=r.vertexTextures;let m=r.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function y(T){return c.add(T),T===0?"uv":`uv${T}`}function p(T,M,C,H,z){const G=H.fog,Y=z.geometry,W=T.isMeshStandardMaterial?H.environment:null,j=(T.isMeshStandardMaterial?t:e).get(T.envMap||W),N=j&&j.mapping===Cr?j.image.height:null,te=x[T.type];T.precision!==null&&(m=r.getMaxPrecision(T.precision),m!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",m,"instead."));const ae=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,_e=ae!==void 0?ae.length:0;let Te=0;Y.morphAttributes.position!==void 0&&(Te=1),Y.morphAttributes.normal!==void 0&&(Te=2),Y.morphAttributes.color!==void 0&&(Te=3);let Ye,X,ee,fe;if(te){const $e=Kt[te];Ye=$e.vertexShader,X=$e.fragmentShader}else Ye=T.vertexShader,X=T.fragmentShader,l.update(T),ee=l.getVertexShaderID(T),fe=l.getFragmentShaderID(T);const ne=i.getRenderTarget(),Se=i.state.buffers.depth.getReversed(),Ae=z.isInstancedMesh===!0,Pe=z.isBatchedMesh===!0,Ke=!!T.map,Fe=!!T.matcap,Qe=!!j,P=!!T.aoMap,Ct=!!T.lightMap,Oe=!!T.bumpMap,Be=!!T.normalMap,Me=!!T.displacementMap,et=!!T.emissiveMap,xe=!!T.metalnessMap,w=!!T.roughnessMap,g=T.anisotropy>0,F=T.clearcoat>0,$=T.dispersion>0,Z=T.iridescence>0,q=T.sheen>0,ve=T.transmission>0,oe=g&&!!T.anisotropyMap,de=F&&!!T.clearcoatMap,Ve=F&&!!T.clearcoatNormalMap,Q=F&&!!T.clearcoatRoughnessMap,pe=Z&&!!T.iridescenceMap,be=Z&&!!T.iridescenceThicknessMap,we=q&&!!T.sheenColorMap,me=q&&!!T.sheenRoughnessMap,ze=!!T.specularMap,Ue=!!T.specularColorMap,Je=!!T.specularIntensityMap,L=ve&&!!T.transmissionMap,re=ve&&!!T.thicknessMap,k=!!T.gradientMap,K=!!T.alphaMap,ce=T.alphaTest>0,le=!!T.alphaHash,De=!!T.extensions;let it=yn;T.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(it=i.toneMapping);const mt={shaderID:te,shaderType:T.type,shaderName:T.name,vertexShader:Ye,fragmentShader:X,defines:T.defines,customVertexShaderID:ee,customFragmentShaderID:fe,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:m,batching:Pe,batchingColor:Pe&&z._colorsTexture!==null,instancing:Ae,instancingColor:Ae&&z.instanceColor!==null,instancingMorph:Ae&&z.morphTexture!==null,supportsVertexTextures:h,outputColorSpace:ne===null?i.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:_i,alphaToCoverage:!!T.alphaToCoverage,map:Ke,matcap:Fe,envMap:Qe,envMapMode:Qe&&j.mapping,envMapCubeUVHeight:N,aoMap:P,lightMap:Ct,bumpMap:Oe,normalMap:Be,displacementMap:h&&Me,emissiveMap:et,normalMapObjectSpace:Be&&T.normalMapType===lc,normalMapTangentSpace:Be&&T.normalMapType===oc,metalnessMap:xe,roughnessMap:w,anisotropy:g,anisotropyMap:oe,clearcoat:F,clearcoatMap:de,clearcoatNormalMap:Ve,clearcoatRoughnessMap:Q,dispersion:$,iridescence:Z,iridescenceMap:pe,iridescenceThicknessMap:be,sheen:q,sheenColorMap:we,sheenRoughnessMap:me,specularMap:ze,specularColorMap:Ue,specularIntensityMap:Je,transmission:ve,transmissionMap:L,thicknessMap:re,gradientMap:k,opaque:T.transparent===!1&&T.blending===ci&&T.alphaToCoverage===!1,alphaMap:K,alphaTest:ce,alphaHash:le,combine:T.combine,mapUv:Ke&&y(T.map.channel),aoMapUv:P&&y(T.aoMap.channel),lightMapUv:Ct&&y(T.lightMap.channel),bumpMapUv:Oe&&y(T.bumpMap.channel),normalMapUv:Be&&y(T.normalMap.channel),displacementMapUv:Me&&y(T.displacementMap.channel),emissiveMapUv:et&&y(T.emissiveMap.channel),metalnessMapUv:xe&&y(T.metalnessMap.channel),roughnessMapUv:w&&y(T.roughnessMap.channel),anisotropyMapUv:oe&&y(T.anisotropyMap.channel),clearcoatMapUv:de&&y(T.clearcoatMap.channel),clearcoatNormalMapUv:Ve&&y(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Q&&y(T.clearcoatRoughnessMap.channel),iridescenceMapUv:pe&&y(T.iridescenceMap.channel),iridescenceThicknessMapUv:be&&y(T.iridescenceThicknessMap.channel),sheenColorMapUv:we&&y(T.sheenColorMap.channel),sheenRoughnessMapUv:me&&y(T.sheenRoughnessMap.channel),specularMapUv:ze&&y(T.specularMap.channel),specularColorMapUv:Ue&&y(T.specularColorMap.channel),specularIntensityMapUv:Je&&y(T.specularIntensityMap.channel),transmissionMapUv:L&&y(T.transmissionMap.channel),thicknessMapUv:re&&y(T.thicknessMap.channel),alphaMapUv:K&&y(T.alphaMap.channel),vertexTangents:!!Y.attributes.tangent&&(Be||g),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,pointsUvs:z.isPoints===!0&&!!Y.attributes.uv&&(Ke||K),fog:!!G,useFog:T.fog===!0,fogExp2:!!G&&G.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:d,reverseDepthBuffer:Se,skinning:z.isSkinnedMesh===!0,morphTargets:Y.morphAttributes.position!==void 0,morphNormals:Y.morphAttributes.normal!==void 0,morphColors:Y.morphAttributes.color!==void 0,morphTargetsCount:_e,morphTextureStride:Te,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:T.dithering,shadowMapEnabled:i.shadowMap.enabled&&C.length>0,shadowMapType:i.shadowMap.type,toneMapping:it,decodeVideoTexture:Ke&&T.map.isVideoTexture===!0&&ke.getTransfer(T.map.colorSpace)===Ze,decodeVideoTextureEmissive:et&&T.emissiveMap.isVideoTexture===!0&&ke.getTransfer(T.emissiveMap.colorSpace)===Ze,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===on,flipSided:T.side===Tt,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:De&&T.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(De&&T.extensions.multiDraw===!0||Pe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return mt.vertexUv1s=c.has(1),mt.vertexUv2s=c.has(2),mt.vertexUv3s=c.has(3),c.clear(),mt}function f(T){const M=[];if(T.shaderID?M.push(T.shaderID):(M.push(T.customVertexShaderID),M.push(T.customFragmentShaderID)),T.defines!==void 0)for(const C in T.defines)M.push(C),M.push(T.defines[C]);return T.isRawShaderMaterial===!1&&(S(M,T),_(M,T),M.push(i.outputColorSpace)),M.push(T.customProgramCacheKey),M.join()}function S(T,M){T.push(M.precision),T.push(M.outputColorSpace),T.push(M.envMapMode),T.push(M.envMapCubeUVHeight),T.push(M.mapUv),T.push(M.alphaMapUv),T.push(M.lightMapUv),T.push(M.aoMapUv),T.push(M.bumpMapUv),T.push(M.normalMapUv),T.push(M.displacementMapUv),T.push(M.emissiveMapUv),T.push(M.metalnessMapUv),T.push(M.roughnessMapUv),T.push(M.anisotropyMapUv),T.push(M.clearcoatMapUv),T.push(M.clearcoatNormalMapUv),T.push(M.clearcoatRoughnessMapUv),T.push(M.iridescenceMapUv),T.push(M.iridescenceThicknessMapUv),T.push(M.sheenColorMapUv),T.push(M.sheenRoughnessMapUv),T.push(M.specularMapUv),T.push(M.specularColorMapUv),T.push(M.specularIntensityMapUv),T.push(M.transmissionMapUv),T.push(M.thicknessMapUv),T.push(M.combine),T.push(M.fogExp2),T.push(M.sizeAttenuation),T.push(M.morphTargetsCount),T.push(M.morphAttributeCount),T.push(M.numDirLights),T.push(M.numPointLights),T.push(M.numSpotLights),T.push(M.numSpotLightMaps),T.push(M.numHemiLights),T.push(M.numRectAreaLights),T.push(M.numDirLightShadows),T.push(M.numPointLightShadows),T.push(M.numSpotLightShadows),T.push(M.numSpotLightShadowsWithMaps),T.push(M.numLightProbes),T.push(M.shadowMapType),T.push(M.toneMapping),T.push(M.numClippingPlanes),T.push(M.numClipIntersection),T.push(M.depthPacking)}function _(T,M){a.disableAll(),M.supportsVertexTextures&&a.enable(0),M.instancing&&a.enable(1),M.instancingColor&&a.enable(2),M.instancingMorph&&a.enable(3),M.matcap&&a.enable(4),M.envMap&&a.enable(5),M.normalMapObjectSpace&&a.enable(6),M.normalMapTangentSpace&&a.enable(7),M.clearcoat&&a.enable(8),M.iridescence&&a.enable(9),M.alphaTest&&a.enable(10),M.vertexColors&&a.enable(11),M.vertexAlphas&&a.enable(12),M.vertexUv1s&&a.enable(13),M.vertexUv2s&&a.enable(14),M.vertexUv3s&&a.enable(15),M.vertexTangents&&a.enable(16),M.anisotropy&&a.enable(17),M.alphaHash&&a.enable(18),M.batching&&a.enable(19),M.dispersion&&a.enable(20),M.batchingColor&&a.enable(21),T.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reverseDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.decodeVideoTextureEmissive&&a.enable(20),M.alphaToCoverage&&a.enable(21),T.push(a.mask)}function v(T){const M=x[T.type];let C;if(M){const H=Kt[M];C=zc.clone(H.uniforms)}else C=T.uniforms;return C}function R(T,M){let C;for(let H=0,z=u.length;H<z;H++){const G=u[H];if(G.cacheKey===M){C=G,++C.usedTimes;break}}return C===void 0&&(C=new cp(i,M,T,s),u.push(C)),C}function b(T){if(--T.usedTimes===0){const M=u.indexOf(T);u[M]=u[u.length-1],u.pop(),T.destroy()}}function A(T){l.remove(T)}function D(){l.dispose()}return{getParameters:p,getProgramCacheKey:f,getUniforms:v,acquireProgram:R,releaseProgram:b,releaseShaderCache:A,programs:u,dispose:D}}function pp(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function r(o,a,l){i.get(o)[a]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function mp(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function go(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function _o(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function o(d,h,m,x,y,p){let f=i[e];return f===void 0?(f={id:d.id,object:d,geometry:h,material:m,groupOrder:x,renderOrder:d.renderOrder,z:y,group:p},i[e]=f):(f.id=d.id,f.object=d,f.geometry=h,f.material=m,f.groupOrder=x,f.renderOrder=d.renderOrder,f.z=y,f.group=p),e++,f}function a(d,h,m,x,y,p){const f=o(d,h,m,x,y,p);m.transmission>0?n.push(f):m.transparent===!0?r.push(f):t.push(f)}function l(d,h,m,x,y,p){const f=o(d,h,m,x,y,p);m.transmission>0?n.unshift(f):m.transparent===!0?r.unshift(f):t.unshift(f)}function c(d,h){t.length>1&&t.sort(d||mp),n.length>1&&n.sort(h||go),r.length>1&&r.sort(h||go)}function u(){for(let d=e,h=i.length;d<h;d++){const m=i[d];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:a,unshift:l,finish:u,sort:c}}function gp(){let i=new WeakMap;function e(n,r){const s=i.get(n);let o;return s===void 0?(o=new _o,i.set(n,[o])):r>=s.length?(o=new _o,s.push(o)):o=s[r],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function _p(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new V,color:new je};break;case"SpotLight":t={position:new V,direction:new V,color:new je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new V,color:new je,distance:0,decay:0};break;case"HemisphereLight":t={direction:new V,skyColor:new je,groundColor:new je};break;case"RectAreaLight":t={color:new je,position:new V,halfWidth:new V,halfHeight:new V};break}return i[e.id]=t,t}}}function vp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new qe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let xp=0;function Mp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Sp(i){const e=new _p,t=vp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new V);const r=new V,s=new lt,o=new lt;function a(c){let u=0,d=0,h=0;for(let T=0;T<9;T++)n.probe[T].set(0,0,0);let m=0,x=0,y=0,p=0,f=0,S=0,_=0,v=0,R=0,b=0,A=0;c.sort(Mp);for(let T=0,M=c.length;T<M;T++){const C=c[T],H=C.color,z=C.intensity,G=C.distance,Y=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)u+=H.r*z,d+=H.g*z,h+=H.b*z;else if(C.isLightProbe){for(let W=0;W<9;W++)n.probe[W].addScaledVector(C.sh.coefficients[W],z);A++}else if(C.isDirectionalLight){const W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const j=C.shadow,N=t.get(C);N.shadowIntensity=j.intensity,N.shadowBias=j.bias,N.shadowNormalBias=j.normalBias,N.shadowRadius=j.radius,N.shadowMapSize=j.mapSize,n.directionalShadow[m]=N,n.directionalShadowMap[m]=Y,n.directionalShadowMatrix[m]=C.shadow.matrix,S++}n.directional[m]=W,m++}else if(C.isSpotLight){const W=e.get(C);W.position.setFromMatrixPosition(C.matrixWorld),W.color.copy(H).multiplyScalar(z),W.distance=G,W.coneCos=Math.cos(C.angle),W.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),W.decay=C.decay,n.spot[y]=W;const j=C.shadow;if(C.map&&(n.spotLightMap[R]=C.map,R++,j.updateMatrices(C),C.castShadow&&b++),n.spotLightMatrix[y]=j.matrix,C.castShadow){const N=t.get(C);N.shadowIntensity=j.intensity,N.shadowBias=j.bias,N.shadowNormalBias=j.normalBias,N.shadowRadius=j.radius,N.shadowMapSize=j.mapSize,n.spotShadow[y]=N,n.spotShadowMap[y]=Y,v++}y++}else if(C.isRectAreaLight){const W=e.get(C);W.color.copy(H).multiplyScalar(z),W.halfWidth.set(C.width*.5,0,0),W.halfHeight.set(0,C.height*.5,0),n.rectArea[p]=W,p++}else if(C.isPointLight){const W=e.get(C);if(W.color.copy(C.color).multiplyScalar(C.intensity),W.distance=C.distance,W.decay=C.decay,C.castShadow){const j=C.shadow,N=t.get(C);N.shadowIntensity=j.intensity,N.shadowBias=j.bias,N.shadowNormalBias=j.normalBias,N.shadowRadius=j.radius,N.shadowMapSize=j.mapSize,N.shadowCameraNear=j.camera.near,N.shadowCameraFar=j.camera.far,n.pointShadow[x]=N,n.pointShadowMap[x]=Y,n.pointShadowMatrix[x]=C.shadow.matrix,_++}n.point[x]=W,x++}else if(C.isHemisphereLight){const W=e.get(C);W.skyColor.copy(C.color).multiplyScalar(z),W.groundColor.copy(C.groundColor).multiplyScalar(z),n.hemi[f]=W,f++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ie.LTC_FLOAT_1,n.rectAreaLTC2=ie.LTC_FLOAT_2):(n.rectAreaLTC1=ie.LTC_HALF_1,n.rectAreaLTC2=ie.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=d,n.ambient[2]=h;const D=n.hash;(D.directionalLength!==m||D.pointLength!==x||D.spotLength!==y||D.rectAreaLength!==p||D.hemiLength!==f||D.numDirectionalShadows!==S||D.numPointShadows!==_||D.numSpotShadows!==v||D.numSpotMaps!==R||D.numLightProbes!==A)&&(n.directional.length=m,n.spot.length=y,n.rectArea.length=p,n.point.length=x,n.hemi.length=f,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=_,n.pointShadowMap.length=_,n.spotShadow.length=v,n.spotShadowMap.length=v,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=_,n.spotLightMatrix.length=v+R-b,n.spotLightMap.length=R,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=A,D.directionalLength=m,D.pointLength=x,D.spotLength=y,D.rectAreaLength=p,D.hemiLength=f,D.numDirectionalShadows=S,D.numPointShadows=_,D.numSpotShadows=v,D.numSpotMaps=R,D.numLightProbes=A,n.version=xp++)}function l(c,u){let d=0,h=0,m=0,x=0,y=0;const p=u.matrixWorldInverse;for(let f=0,S=c.length;f<S;f++){const _=c[f];if(_.isDirectionalLight){const v=n.directional[d];v.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),v.direction.sub(r),v.direction.transformDirection(p),d++}else if(_.isSpotLight){const v=n.spot[m];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(p),v.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),v.direction.sub(r),v.direction.transformDirection(p),m++}else if(_.isRectAreaLight){const v=n.rectArea[x];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(p),o.identity(),s.copy(_.matrixWorld),s.premultiply(p),o.extractRotation(s),v.halfWidth.set(_.width*.5,0,0),v.halfHeight.set(0,_.height*.5,0),v.halfWidth.applyMatrix4(o),v.halfHeight.applyMatrix4(o),x++}else if(_.isPointLight){const v=n.point[h];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(p),h++}else if(_.isHemisphereLight){const v=n.hemi[y];v.direction.setFromMatrixPosition(_.matrixWorld),v.direction.transformDirection(p),y++}}}return{setup:a,setupView:l,state:n}}function vo(i){const e=new Sp(i),t=[],n=[];function r(u){c.camera=u,t.length=0,n.length=0}function s(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function Ep(i){let e=new WeakMap;function t(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new vo(i),e.set(r,[a])):s>=o.length?(a=new vo(i),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}const yp=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function bp(i,e,t){let n=new tl;const r=new qe,s=new qe,o=new st,a=new $c({depthPacking:ac}),l=new Kc,c={},u=t.maxTextureSize,d={[Tn]:Tt,[Tt]:Tn,[on]:on},h=new hn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:yp,fragmentShader:Tp}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const x=new Gn;x.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new jt(x,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Po;let f=this.type;this.render=function(b,A,D){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const T=i.getRenderTarget(),M=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),H=i.state;H.setBlending(En),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);const z=f!==an&&this.type===an,G=f===an&&this.type!==an;for(let Y=0,W=b.length;Y<W;Y++){const j=b[Y],N=j.shadow;if(N===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;r.copy(N.mapSize);const te=N.getFrameExtents();if(r.multiply(te),s.copy(N.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/te.x),r.x=s.x*te.x,N.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/te.y),r.y=s.y*te.y,N.mapSize.y=s.y)),N.map===null||z===!0||G===!0){const _e=this.type!==an?{minFilter:qt,magFilter:qt}:{};N.map!==null&&N.map.dispose(),N.map=new Hn(r.x,r.y,_e),N.map.texture.name=j.name+".shadowMap",N.camera.updateProjectionMatrix()}i.setRenderTarget(N.map),i.clear();const ae=N.getViewportCount();for(let _e=0;_e<ae;_e++){const Te=N.getViewport(_e);o.set(s.x*Te.x,s.y*Te.y,s.x*Te.z,s.y*Te.w),H.viewport(o),N.updateMatrices(j,_e),n=N.getFrustum(),v(A,D,N.camera,j,this.type)}N.isPointLightShadow!==!0&&this.type===an&&S(N,D),N.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(T,M,C)};function S(b,A){const D=e.update(y);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Hn(r.x,r.y)),h.uniforms.shadow_pass.value=b.map.texture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(A,null,D,h,y,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(A,null,D,m,y,null)}function _(b,A,D,T){let M=null;const C=D.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)M=C;else if(M=D.isPointLight===!0?l:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const H=M.uuid,z=A.uuid;let G=c[H];G===void 0&&(G={},c[H]=G);let Y=G[z];Y===void 0&&(Y=M.clone(),G[z]=Y,A.addEventListener("dispose",R)),M=Y}if(M.visible=A.visible,M.wireframe=A.wireframe,T===an?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:d[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,D.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const H=i.properties.get(M);H.light=D}return M}function v(b,A,D,T,M){if(b.visible===!1)return;if(b.layers.test(A.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===an)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,b.matrixWorld);const z=e.update(b),G=b.material;if(Array.isArray(G)){const Y=z.groups;for(let W=0,j=Y.length;W<j;W++){const N=Y[W],te=G[N.materialIndex];if(te&&te.visible){const ae=_(b,te,T,M);b.onBeforeShadow(i,b,A,D,z,ae,N),i.renderBufferDirect(D,null,z,ae,b,N),b.onAfterShadow(i,b,A,D,z,ae,N)}}}else if(G.visible){const Y=_(b,G,T,M);b.onBeforeShadow(i,b,A,D,z,Y,null),i.renderBufferDirect(D,null,z,Y,b,null),b.onAfterShadow(i,b,A,D,z,Y,null)}}const H=b.children;for(let z=0,G=H.length;z<G;z++)v(H[z],A,D,T,M)}function R(b){b.target.removeEventListener("dispose",R);for(const D in c){const T=c[D],M=b.target.uuid;M in T&&(T[M].dispose(),delete T[M])}}}const Ap={[ms]:gs,[_s]:Ms,[vs]:Ss,[di]:xs,[gs]:ms,[Ms]:_s,[Ss]:vs,[xs]:di};function wp(i,e){function t(){let L=!1;const re=new st;let k=null;const K=new st(0,0,0,0);return{setMask:function(ce){k!==ce&&!L&&(i.colorMask(ce,ce,ce,ce),k=ce)},setLocked:function(ce){L=ce},setClear:function(ce,le,De,it,mt){mt===!0&&(ce*=it,le*=it,De*=it),re.set(ce,le,De,it),K.equals(re)===!1&&(i.clearColor(ce,le,De,it),K.copy(re))},reset:function(){L=!1,k=null,K.set(-1,0,0,0)}}}function n(){let L=!1,re=!1,k=null,K=null,ce=null;return{setReversed:function(le){if(re!==le){const De=e.get("EXT_clip_control");re?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);const it=ce;ce=null,this.setClear(it)}re=le},getReversed:function(){return re},setTest:function(le){le?ne(i.DEPTH_TEST):Se(i.DEPTH_TEST)},setMask:function(le){k!==le&&!L&&(i.depthMask(le),k=le)},setFunc:function(le){if(re&&(le=Ap[le]),K!==le){switch(le){case ms:i.depthFunc(i.NEVER);break;case gs:i.depthFunc(i.ALWAYS);break;case _s:i.depthFunc(i.LESS);break;case di:i.depthFunc(i.LEQUAL);break;case vs:i.depthFunc(i.EQUAL);break;case xs:i.depthFunc(i.GEQUAL);break;case Ms:i.depthFunc(i.GREATER);break;case Ss:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}K=le}},setLocked:function(le){L=le},setClear:function(le){ce!==le&&(re&&(le=1-le),i.clearDepth(le),ce=le)},reset:function(){L=!1,k=null,K=null,ce=null,re=!1}}}function r(){let L=!1,re=null,k=null,K=null,ce=null,le=null,De=null,it=null,mt=null;return{setTest:function($e){L||($e?ne(i.STENCIL_TEST):Se(i.STENCIL_TEST))},setMask:function($e){re!==$e&&!L&&(i.stencilMask($e),re=$e)},setFunc:function($e,Ot,Qt){(k!==$e||K!==Ot||ce!==Qt)&&(i.stencilFunc($e,Ot,Qt),k=$e,K=Ot,ce=Qt)},setOp:function($e,Ot,Qt){(le!==$e||De!==Ot||it!==Qt)&&(i.stencilOp($e,Ot,Qt),le=$e,De=Ot,it=Qt)},setLocked:function($e){L=$e},setClear:function($e){mt!==$e&&(i.clearStencil($e),mt=$e)},reset:function(){L=!1,re=null,k=null,K=null,ce=null,le=null,De=null,it=null,mt=null}}}const s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},h=new WeakMap,m=[],x=null,y=!1,p=null,f=null,S=null,_=null,v=null,R=null,b=null,A=new je(0,0,0),D=0,T=!1,M=null,C=null,H=null,z=null,G=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,j=0;const N=i.getParameter(i.VERSION);N.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(N)[1]),W=j>=1):N.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(N)[1]),W=j>=2);let te=null,ae={};const _e=i.getParameter(i.SCISSOR_BOX),Te=i.getParameter(i.VIEWPORT),Ye=new st().fromArray(_e),X=new st().fromArray(Te);function ee(L,re,k,K){const ce=new Uint8Array(4),le=i.createTexture();i.bindTexture(L,le),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let De=0;De<k;De++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(re,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,ce):i.texImage2D(re+De,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ce);return le}const fe={};fe[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),fe[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),fe[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ne(i.DEPTH_TEST),o.setFunc(di),Oe(!1),Be(Ea),ne(i.CULL_FACE),P(En);function ne(L){u[L]!==!0&&(i.enable(L),u[L]=!0)}function Se(L){u[L]!==!1&&(i.disable(L),u[L]=!1)}function Ae(L,re){return d[L]!==re?(i.bindFramebuffer(L,re),d[L]=re,L===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=re),L===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=re),!0):!1}function Pe(L,re){let k=m,K=!1;if(L){k=h.get(re),k===void 0&&(k=[],h.set(re,k));const ce=L.textures;if(k.length!==ce.length||k[0]!==i.COLOR_ATTACHMENT0){for(let le=0,De=ce.length;le<De;le++)k[le]=i.COLOR_ATTACHMENT0+le;k.length=ce.length,K=!0}}else k[0]!==i.BACK&&(k[0]=i.BACK,K=!0);K&&i.drawBuffers(k)}function Ke(L){return x!==L?(i.useProgram(L),x=L,!0):!1}const Fe={[Nn]:i.FUNC_ADD,[Ll]:i.FUNC_SUBTRACT,[Ul]:i.FUNC_REVERSE_SUBTRACT};Fe[Il]=i.MIN,Fe[Fl]=i.MAX;const Qe={[Nl]:i.ZERO,[Ol]:i.ONE,[Bl]:i.SRC_COLOR,[hs]:i.SRC_ALPHA,[Wl]:i.SRC_ALPHA_SATURATE,[Gl]:i.DST_COLOR,[Vl]:i.DST_ALPHA,[zl]:i.ONE_MINUS_SRC_COLOR,[ps]:i.ONE_MINUS_SRC_ALPHA,[kl]:i.ONE_MINUS_DST_COLOR,[Hl]:i.ONE_MINUS_DST_ALPHA,[Xl]:i.CONSTANT_COLOR,[ql]:i.ONE_MINUS_CONSTANT_COLOR,[Yl]:i.CONSTANT_ALPHA,[$l]:i.ONE_MINUS_CONSTANT_ALPHA};function P(L,re,k,K,ce,le,De,it,mt,$e){if(L===En){y===!0&&(Se(i.BLEND),y=!1);return}if(y===!1&&(ne(i.BLEND),y=!0),L!==Dl){if(L!==p||$e!==T){if((f!==Nn||v!==Nn)&&(i.blendEquation(i.FUNC_ADD),f=Nn,v=Nn),$e)switch(L){case ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ya:i.blendFunc(i.ONE,i.ONE);break;case Ta:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ya:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ta:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ba:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}S=null,_=null,R=null,b=null,A.set(0,0,0),D=0,p=L,T=$e}return}ce=ce||re,le=le||k,De=De||K,(re!==f||ce!==v)&&(i.blendEquationSeparate(Fe[re],Fe[ce]),f=re,v=ce),(k!==S||K!==_||le!==R||De!==b)&&(i.blendFuncSeparate(Qe[k],Qe[K],Qe[le],Qe[De]),S=k,_=K,R=le,b=De),(it.equals(A)===!1||mt!==D)&&(i.blendColor(it.r,it.g,it.b,mt),A.copy(it),D=mt),p=L,T=!1}function Ct(L,re){L.side===on?Se(i.CULL_FACE):ne(i.CULL_FACE);let k=L.side===Tt;re&&(k=!k),Oe(k),L.blending===ci&&L.transparent===!1?P(En):P(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),s.setMask(L.colorWrite);const K=L.stencilWrite;a.setTest(K),K&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),et(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ne(i.SAMPLE_ALPHA_TO_COVERAGE):Se(i.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(L){M!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),M=L)}function Be(L){L!==Rl?(ne(i.CULL_FACE),L!==C&&(L===Ea?i.cullFace(i.BACK):L===Cl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Se(i.CULL_FACE),C=L}function Me(L){L!==H&&(W&&i.lineWidth(L),H=L)}function et(L,re,k){L?(ne(i.POLYGON_OFFSET_FILL),(z!==re||G!==k)&&(i.polygonOffset(re,k),z=re,G=k)):Se(i.POLYGON_OFFSET_FILL)}function xe(L){L?ne(i.SCISSOR_TEST):Se(i.SCISSOR_TEST)}function w(L){L===void 0&&(L=i.TEXTURE0+Y-1),te!==L&&(i.activeTexture(L),te=L)}function g(L,re,k){k===void 0&&(te===null?k=i.TEXTURE0+Y-1:k=te);let K=ae[k];K===void 0&&(K={type:void 0,texture:void 0},ae[k]=K),(K.type!==L||K.texture!==re)&&(te!==k&&(i.activeTexture(k),te=k),i.bindTexture(L,re||fe[L]),K.type=L,K.texture=re)}function F(){const L=ae[te];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function $(){try{i.compressedTexImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ve(){try{i.texSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function oe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function de(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ve(){try{i.texStorage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function pe(){try{i.texImage2D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function be(){try{i.texImage3D.apply(i,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function we(L){Ye.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),Ye.copy(L))}function me(L){X.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),X.copy(L))}function ze(L,re){let k=c.get(re);k===void 0&&(k=new WeakMap,c.set(re,k));let K=k.get(L);K===void 0&&(K=i.getUniformBlockIndex(re,L.name),k.set(L,K))}function Ue(L,re){const K=c.get(re).get(L);l.get(re)!==K&&(i.uniformBlockBinding(re,K,L.__bindingPointIndex),l.set(re,K))}function Je(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},te=null,ae={},d={},h=new WeakMap,m=[],x=null,y=!1,p=null,f=null,S=null,_=null,v=null,R=null,b=null,A=new je(0,0,0),D=0,T=!1,M=null,C=null,H=null,z=null,G=null,Ye.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ne,disable:Se,bindFramebuffer:Ae,drawBuffers:Pe,useProgram:Ke,setBlending:P,setMaterial:Ct,setFlipSided:Oe,setCullFace:Be,setLineWidth:Me,setPolygonOffset:et,setScissorTest:xe,activeTexture:w,bindTexture:g,unbindTexture:F,compressedTexImage2D:$,compressedTexImage3D:Z,texImage2D:pe,texImage3D:be,updateUBOMapping:ze,uniformBlockBinding:Ue,texStorage2D:Ve,texStorage3D:Q,texSubImage2D:q,texSubImage3D:ve,compressedTexSubImage2D:oe,compressedTexSubImage3D:de,scissor:we,viewport:me,reset:Je}}function Rp(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new qe,u=new WeakMap;let d;const h=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(w,g){return m?new OffscreenCanvas(w,g):Li("canvas")}function y(w,g,F){let $=1;const Z=xe(w);if((Z.width>F||Z.height>F)&&($=F/Math.max(Z.width,Z.height)),$<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const q=Math.floor($*Z.width),ve=Math.floor($*Z.height);d===void 0&&(d=x(q,ve));const oe=g?x(q,ve):d;return oe.width=q,oe.height=ve,oe.getContext("2d").drawImage(w,0,0,q,ve),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+ve+")."),oe}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),w;return w}function p(w){return w.generateMipmaps}function f(w){i.generateMipmap(w)}function S(w){return w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?i.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function _(w,g,F,$,Z=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=g;if(g===i.RED&&(F===i.FLOAT&&(q=i.R32F),F===i.HALF_FLOAT&&(q=i.R16F),F===i.UNSIGNED_BYTE&&(q=i.R8)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.R8UI),F===i.UNSIGNED_SHORT&&(q=i.R16UI),F===i.UNSIGNED_INT&&(q=i.R32UI),F===i.BYTE&&(q=i.R8I),F===i.SHORT&&(q=i.R16I),F===i.INT&&(q=i.R32I)),g===i.RG&&(F===i.FLOAT&&(q=i.RG32F),F===i.HALF_FLOAT&&(q=i.RG16F),F===i.UNSIGNED_BYTE&&(q=i.RG8)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RG8UI),F===i.UNSIGNED_SHORT&&(q=i.RG16UI),F===i.UNSIGNED_INT&&(q=i.RG32UI),F===i.BYTE&&(q=i.RG8I),F===i.SHORT&&(q=i.RG16I),F===i.INT&&(q=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGB8UI),F===i.UNSIGNED_SHORT&&(q=i.RGB16UI),F===i.UNSIGNED_INT&&(q=i.RGB32UI),F===i.BYTE&&(q=i.RGB8I),F===i.SHORT&&(q=i.RGB16I),F===i.INT&&(q=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),F===i.UNSIGNED_INT&&(q=i.RGBA32UI),F===i.BYTE&&(q=i.RGBA8I),F===i.SHORT&&(q=i.RGBA16I),F===i.INT&&(q=i.RGBA32I)),g===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),g===i.RGBA){const ve=Z?wr:ke.getTransfer($);F===i.FLOAT&&(q=i.RGBA32F),F===i.HALF_FLOAT&&(q=i.RGBA16F),F===i.UNSIGNED_BYTE&&(q=ve===Ze?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function v(w,g){let F;return w?g===null||g===Vn||g===mi?F=i.DEPTH24_STENCIL8:g===ln?F=i.DEPTH32F_STENCIL8:g===Di&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Vn||g===mi?F=i.DEPTH_COMPONENT24:g===ln?F=i.DEPTH_COMPONENT32F:g===Di&&(F=i.DEPTH_COMPONENT16),F}function R(w,g){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==qt&&w.minFilter!==yt?Math.log2(Math.max(g.width,g.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?g.mipmaps.length:1}function b(w){const g=w.target;g.removeEventListener("dispose",b),D(g),g.isVideoTexture&&u.delete(g)}function A(w){const g=w.target;g.removeEventListener("dispose",A),M(g)}function D(w){const g=n.get(w);if(g.__webglInit===void 0)return;const F=w.source,$=h.get(F);if($){const Z=$[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&T(w),Object.keys($).length===0&&h.delete(F)}n.remove(w)}function T(w){const g=n.get(w);i.deleteTexture(g.__webglTexture);const F=w.source,$=h.get(F);delete $[g.__cacheKey],o.memory.textures--}function M(w){const g=n.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),n.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(g.__webglFramebuffer[$]))for(let Z=0;Z<g.__webglFramebuffer[$].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[$][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[$]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[$])}else{if(Array.isArray(g.__webglFramebuffer))for(let $=0;$<g.__webglFramebuffer.length;$++)i.deleteFramebuffer(g.__webglFramebuffer[$]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let $=0;$<g.__webglColorRenderbuffer.length;$++)g.__webglColorRenderbuffer[$]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[$]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=w.textures;for(let $=0,Z=F.length;$<Z;$++){const q=n.get(F[$]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),o.memory.textures--),n.remove(F[$])}n.remove(w)}let C=0;function H(){C=0}function z(){const w=C;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),C+=1,w}function G(w){const g=[];return g.push(w.wrapS),g.push(w.wrapT),g.push(w.wrapR||0),g.push(w.magFilter),g.push(w.minFilter),g.push(w.anisotropy),g.push(w.internalFormat),g.push(w.format),g.push(w.type),g.push(w.generateMipmaps),g.push(w.premultiplyAlpha),g.push(w.flipY),g.push(w.unpackAlignment),g.push(w.colorSpace),g.join()}function Y(w,g){const F=n.get(w);if(w.isVideoTexture&&Me(w),w.isRenderTargetTexture===!1&&w.version>0&&F.__version!==w.version){const $=w.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(F,w,g);return}}t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function W(w,g){const F=n.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function j(w,g){const F=n.get(w);if(w.version>0&&F.__version!==w.version){X(F,w,g);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function N(w,g){const F=n.get(w);if(w.version>0&&F.__version!==w.version){ee(F,w,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const te={[br]:i.REPEAT,[Zt]:i.CLAMP_TO_EDGE,[Ar]:i.MIRRORED_REPEAT},ae={[qt]:i.NEAREST,[rc]:i.NEAREST_MIPMAP_NEAREST,[Gi]:i.NEAREST_MIPMAP_LINEAR,[yt]:i.LINEAR,[Fr]:i.LINEAR_MIPMAP_NEAREST,[Bn]:i.LINEAR_MIPMAP_LINEAR},_e={[cc]:i.NEVER,[mc]:i.ALWAYS,[uc]:i.LESS,[ko]:i.LEQUAL,[fc]:i.EQUAL,[pc]:i.GEQUAL,[dc]:i.GREATER,[hc]:i.NOTEQUAL};function Te(w,g){if(g.type===ln&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===yt||g.magFilter===Fr||g.magFilter===Gi||g.magFilter===Bn||g.minFilter===yt||g.minFilter===Fr||g.minFilter===Gi||g.minFilter===Bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,te[g.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,te[g.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,te[g.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,ae[g.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,ae[g.minFilter]),g.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,_e[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===qt||g.minFilter!==Gi&&g.minFilter!==Bn||g.type===ln&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ye(w,g){let F=!1;w.__webglInit===void 0&&(w.__webglInit=!0,g.addEventListener("dispose",b));const $=g.source;let Z=h.get($);Z===void 0&&(Z={},h.set($,Z));const q=G(g);if(q!==w.__cacheKey){Z[q]===void 0&&(Z[q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,F=!0),Z[q].usedTimes++;const ve=Z[w.__cacheKey];ve!==void 0&&(Z[w.__cacheKey].usedTimes--,ve.usedTimes===0&&T(g)),w.__cacheKey=q,w.__webglTexture=Z[q].texture}return F}function X(w,g,F){let $=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&($=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&($=i.TEXTURE_3D);const Z=Ye(w,g),q=g.source;t.bindTexture($,w.__webglTexture,i.TEXTURE0+F);const ve=n.get(q);if(q.version!==ve.__version||Z===!0){t.activeTexture(i.TEXTURE0+F);const oe=ke.getPrimaries(ke.workingColorSpace),de=g.colorSpace===Sn?null:ke.getPrimaries(g.colorSpace),Ve=g.colorSpace===Sn||oe===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let Q=y(g.image,!1,r.maxTextureSize);Q=et(g,Q);const pe=s.convert(g.format,g.colorSpace),be=s.convert(g.type);let we=_(g.internalFormat,pe,be,g.colorSpace,g.isVideoTexture);Te($,g);let me;const ze=g.mipmaps,Ue=g.isVideoTexture!==!0,Je=ve.__version===void 0||Z===!0,L=q.dataReady,re=R(g,Q);if(g.isDepthTexture)we=v(g.format===gi,g.type),Je&&(Ue?t.texStorage2D(i.TEXTURE_2D,1,we,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,we,Q.width,Q.height,0,pe,be,null));else if(g.isDataTexture)if(ze.length>0){Ue&&Je&&t.texStorage2D(i.TEXTURE_2D,re,we,ze[0].width,ze[0].height);for(let k=0,K=ze.length;k<K;k++)me=ze[k],Ue?L&&t.texSubImage2D(i.TEXTURE_2D,k,0,0,me.width,me.height,pe,be,me.data):t.texImage2D(i.TEXTURE_2D,k,we,me.width,me.height,0,pe,be,me.data);g.generateMipmaps=!1}else Ue?(Je&&t.texStorage2D(i.TEXTURE_2D,re,we,Q.width,Q.height),L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,pe,be,Q.data)):t.texImage2D(i.TEXTURE_2D,0,we,Q.width,Q.height,0,pe,be,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ue&&Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,we,ze[0].width,ze[0].height,Q.depth);for(let k=0,K=ze.length;k<K;k++)if(me=ze[k],g.format!==Nt)if(pe!==null)if(Ue){if(L)if(g.layerUpdates.size>0){const ce=Ya(me.width,me.height,g.format,g.type);for(const le of g.layerUpdates){const De=me.data.subarray(le*ce/me.data.BYTES_PER_ELEMENT,(le+1)*ce/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,le,me.width,me.height,1,pe,De)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,me.width,me.height,Q.depth,pe,me.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,k,we,me.width,me.height,Q.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,k,0,0,0,me.width,me.height,Q.depth,pe,be,me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,k,we,me.width,me.height,Q.depth,0,pe,be,me.data)}else{Ue&&Je&&t.texStorage2D(i.TEXTURE_2D,re,we,ze[0].width,ze[0].height);for(let k=0,K=ze.length;k<K;k++)me=ze[k],g.format!==Nt?pe!==null?Ue?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,k,0,0,me.width,me.height,pe,me.data):t.compressedTexImage2D(i.TEXTURE_2D,k,we,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?L&&t.texSubImage2D(i.TEXTURE_2D,k,0,0,me.width,me.height,pe,be,me.data):t.texImage2D(i.TEXTURE_2D,k,we,me.width,me.height,0,pe,be,me.data)}else if(g.isDataArrayTexture)if(Ue){if(Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,we,Q.width,Q.height,Q.depth),L)if(g.layerUpdates.size>0){const k=Ya(Q.width,Q.height,g.format,g.type);for(const K of g.layerUpdates){const ce=Q.data.subarray(K*k/Q.data.BYTES_PER_ELEMENT,(K+1)*k/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,Q.width,Q.height,1,pe,be,ce)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,pe,be,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,we,Q.width,Q.height,Q.depth,0,pe,be,Q.data);else if(g.isData3DTexture)Ue?(Je&&t.texStorage3D(i.TEXTURE_3D,re,we,Q.width,Q.height,Q.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,pe,be,Q.data)):t.texImage3D(i.TEXTURE_3D,0,we,Q.width,Q.height,Q.depth,0,pe,be,Q.data);else if(g.isFramebufferTexture){if(Je)if(Ue)t.texStorage2D(i.TEXTURE_2D,re,we,Q.width,Q.height);else{let k=Q.width,K=Q.height;for(let ce=0;ce<re;ce++)t.texImage2D(i.TEXTURE_2D,ce,we,k,K,0,pe,be,null),k>>=1,K>>=1}}else if(ze.length>0){if(Ue&&Je){const k=xe(ze[0]);t.texStorage2D(i.TEXTURE_2D,re,we,k.width,k.height)}for(let k=0,K=ze.length;k<K;k++)me=ze[k],Ue?L&&t.texSubImage2D(i.TEXTURE_2D,k,0,0,pe,be,me):t.texImage2D(i.TEXTURE_2D,k,we,pe,be,me);g.generateMipmaps=!1}else if(Ue){if(Je){const k=xe(Q);t.texStorage2D(i.TEXTURE_2D,re,we,k.width,k.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,be,Q)}else t.texImage2D(i.TEXTURE_2D,0,we,pe,be,Q);p(g)&&f($),ve.__version=q.version,g.onUpdate&&g.onUpdate(g)}w.__version=g.version}function ee(w,g,F){if(g.image.length!==6)return;const $=Ye(w,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+F);const q=n.get(Z);if(Z.version!==q.__version||$===!0){t.activeTexture(i.TEXTURE0+F);const ve=ke.getPrimaries(ke.workingColorSpace),oe=g.colorSpace===Sn?null:ke.getPrimaries(g.colorSpace),de=g.colorSpace===Sn||ve===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Ve=g.isCompressedTexture||g.image[0].isCompressedTexture,Q=g.image[0]&&g.image[0].isDataTexture,pe=[];for(let K=0;K<6;K++)!Ve&&!Q?pe[K]=y(g.image[K],!0,r.maxCubemapSize):pe[K]=Q?g.image[K].image:g.image[K],pe[K]=et(g,pe[K]);const be=pe[0],we=s.convert(g.format,g.colorSpace),me=s.convert(g.type),ze=_(g.internalFormat,we,me,g.colorSpace),Ue=g.isVideoTexture!==!0,Je=q.__version===void 0||$===!0,L=Z.dataReady;let re=R(g,be);Te(i.TEXTURE_CUBE_MAP,g);let k;if(Ve){Ue&&Je&&t.texStorage2D(i.TEXTURE_CUBE_MAP,re,ze,be.width,be.height);for(let K=0;K<6;K++){k=pe[K].mipmaps;for(let ce=0;ce<k.length;ce++){const le=k[ce];g.format!==Nt?we!==null?Ue?L&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,le.width,le.height,we,le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,ze,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ue?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,0,0,le.width,le.height,we,me,le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce,ze,le.width,le.height,0,we,me,le.data)}}}else{if(k=g.mipmaps,Ue&&Je){k.length>0&&re++;const K=xe(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,re,ze,K.width,K.height)}for(let K=0;K<6;K++)if(Q){Ue?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,pe[K].width,pe[K].height,we,me,pe[K].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ze,pe[K].width,pe[K].height,0,we,me,pe[K].data);for(let ce=0;ce<k.length;ce++){const De=k[ce].image[K].image;Ue?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,De.width,De.height,we,me,De.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,ze,De.width,De.height,0,we,me,De.data)}}else{Ue?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,we,me,pe[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ze,we,me,pe[K]);for(let ce=0;ce<k.length;ce++){const le=k[ce];Ue?L&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,0,0,we,me,le.image[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,ce+1,ze,we,me,le.image[K])}}}p(g)&&f(i.TEXTURE_CUBE_MAP),q.__version=Z.version,g.onUpdate&&g.onUpdate(g)}w.__version=g.version}function fe(w,g,F,$,Z,q){const ve=s.convert(F.format,F.colorSpace),oe=s.convert(F.type),de=_(F.internalFormat,ve,oe,F.colorSpace),Ve=n.get(g),Q=n.get(F);if(Q.__renderTarget=g,!Ve.__hasExternalTextures){const pe=Math.max(1,g.width>>q),be=Math.max(1,g.height>>q);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,q,de,pe,be,g.depth,0,ve,oe,null):t.texImage2D(Z,q,de,pe,be,0,ve,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,Z,Q.__webglTexture,0,Oe(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,$,Z,Q.__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ne(w,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,w),g.depthBuffer){const $=g.depthTexture,Z=$&&$.isDepthTexture?$.type:null,q=v(g.stencilBuffer,Z),ve=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=Oe(g);Be(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,q,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,q,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,q,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ve,i.RENDERBUFFER,w)}else{const $=g.textures;for(let Z=0;Z<$.length;Z++){const q=$[Z],ve=s.convert(q.format,q.colorSpace),oe=s.convert(q.type),de=_(q.internalFormat,ve,oe,q.colorSpace),Ve=Oe(g);F&&Be(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ve,de,g.width,g.height):Be(g)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ve,de,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,de,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Se(w,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(g.depthTexture);$.__renderTarget=g,(!$.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),Y(g.depthTexture,0);const Z=$.__webglTexture,q=Oe(g);if(g.depthTexture.format===ui)Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(g.depthTexture.format===gi)Be(g)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Ae(w){const g=n.get(w),F=w.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==w.depthTexture){const $=w.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),$){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,$.removeEventListener("dispose",Z)};$.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=$}if(w.depthTexture&&!g.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Se(g.__webglFramebuffer,w)}else if(F){g.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[$]),g.__webglDepthbuffer[$]===void 0)g.__webglDepthbuffer[$]=i.createRenderbuffer(),ne(g.__webglDepthbuffer[$],w,!1);else{const Z=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=g.__webglDepthbuffer[$];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,q)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),ne(g.__webglDepthbuffer,w,!1);else{const $=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Z=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Z),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,Z)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Pe(w,g,F){const $=n.get(w);g!==void 0&&fe($.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Ae(w)}function Ke(w){const g=w.texture,F=n.get(w),$=n.get(g);w.addEventListener("dispose",A);const Z=w.textures,q=w.isWebGLCubeRenderTarget===!0,ve=Z.length>1;if(ve||($.__webglTexture===void 0&&($.__webglTexture=i.createTexture()),$.__version=g.version,o.memory.textures++),q){F.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[oe]=[];for(let de=0;de<g.mipmaps.length;de++)F.__webglFramebuffer[oe][de]=i.createFramebuffer()}else F.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let oe=0;oe<g.mipmaps.length;oe++)F.__webglFramebuffer[oe]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(ve)for(let oe=0,de=Z.length;oe<de;oe++){const Ve=n.get(Z[oe]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=i.createTexture(),o.memory.textures++)}if(w.samples>0&&Be(w)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const de=Z[oe];F.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[oe]);const Ve=s.convert(de.format,de.colorSpace),Q=s.convert(de.type),pe=_(de.internalFormat,Ve,Q,de.colorSpace,w.isXRRenderTarget===!0),be=Oe(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,be,pe,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,F.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ne(F.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Te(i.TEXTURE_CUBE_MAP,g);for(let oe=0;oe<6;oe++)if(g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)fe(F.__webglFramebuffer[oe][de],w,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,de);else fe(F.__webglFramebuffer[oe],w,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);p(g)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ve){for(let oe=0,de=Z.length;oe<de;oe++){const Ve=Z[oe],Q=n.get(Ve);t.bindTexture(i.TEXTURE_2D,Q.__webglTexture),Te(i.TEXTURE_2D,Ve),fe(F.__webglFramebuffer,w,Ve,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,0),p(Ve)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(oe=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,$.__webglTexture),Te(oe,g),g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)fe(F.__webglFramebuffer[de],w,g,i.COLOR_ATTACHMENT0,oe,de);else fe(F.__webglFramebuffer,w,g,i.COLOR_ATTACHMENT0,oe,0);p(g)&&f(oe),t.unbindTexture()}w.depthBuffer&&Ae(w)}function Fe(w){const g=w.textures;for(let F=0,$=g.length;F<$;F++){const Z=g[F];if(p(Z)){const q=S(w),ve=n.get(Z).__webglTexture;t.bindTexture(q,ve),f(q),t.unbindTexture()}}}const Qe=[],P=[];function Ct(w){if(w.samples>0){if(Be(w)===!1){const g=w.textures,F=w.width,$=w.height;let Z=i.COLOR_BUFFER_BIT;const q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ve=n.get(w),oe=g.length>1;if(oe)for(let de=0;de<g.length;de++)t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ve.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ve.__webglFramebuffer);for(let de=0;de<g.length;de++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ve.__webglColorRenderbuffer[de]);const Ve=n.get(g[de]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ve,0)}i.blitFramebuffer(0,0,F,$,0,0,F,$,Z,i.NEAREST),l===!0&&(Qe.length=0,P.length=0,Qe.push(i.COLOR_ATTACHMENT0+de),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Qe.push(q),P.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Qe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let de=0;de<g.length;de++){t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,ve.__webglColorRenderbuffer[de]);const Ve=n.get(g[de]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ve.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,Ve,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ve.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const g=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Oe(w){return Math.min(r.maxSamples,w.samples)}function Be(w){const g=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Me(w){const g=o.render.frame;u.get(w)!==g&&(u.set(w,g),w.update())}function et(w,g){const F=w.colorSpace,$=w.format,Z=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||F!==_i&&F!==Sn&&(ke.getTransfer(F)===Ze?($!==Nt||Z!==fn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),g}function xe(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=H,this.setTexture2D=Y,this.setTexture2DArray=W,this.setTexture3D=j,this.setTextureCube=N,this.rebindTextures=Pe,this.setupRenderTarget=Ke,this.updateRenderTargetMipmap=Fe,this.updateMultisampleRenderTarget=Ct,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=Be}function Cp(i,e){function t(n,r=Sn){let s;const o=ke.getTransfer(r);if(n===fn)return i.UNSIGNED_BYTE;if(n===ia)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ra)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Fo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Uo)return i.BYTE;if(n===Io)return i.SHORT;if(n===Di)return i.UNSIGNED_SHORT;if(n===na)return i.INT;if(n===Vn)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Ui)return i.HALF_FLOAT;if(n===No)return i.ALPHA;if(n===Oo)return i.RGB;if(n===Nt)return i.RGBA;if(n===Bo)return i.LUMINANCE;if(n===zo)return i.LUMINANCE_ALPHA;if(n===ui)return i.DEPTH_COMPONENT;if(n===gi)return i.DEPTH_STENCIL;if(n===Vo)return i.RED;if(n===sa)return i.RED_INTEGER;if(n===Ho)return i.RG;if(n===aa)return i.RG_INTEGER;if(n===oa)return i.RGBA_INTEGER;if(n===dr||n===hr||n===pr||n===mr)if(o===Ze)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===dr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===pr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===dr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===pr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===mr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ts||n===bs||n===As||n===ws)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ts)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===bs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===As)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ws)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Rs||n===Cs||n===Ps)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Rs||n===Cs)return o===Ze?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ps)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ds||n===Ls||n===Us||n===Is||n===Fs||n===Ns||n===Os||n===Bs||n===zs||n===Vs||n===Hs||n===Gs||n===ks||n===Ws)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ds)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ls)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Us)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Is)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Fs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ns)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Os)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Bs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===zs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Vs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Hs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Gs)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ks)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ws)return o===Ze?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===gr||n===Xs||n===qs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===gr)return o===Ze?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Xs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===qs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Go||n===Ys||n===$s||n===Ks)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===gr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ys)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===$s)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ks)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===mi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Pp={type:"move"};class us{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ar,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ar,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new V,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new V),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ar,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new V,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new V),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const y of e.hand.values()){const p=t.getJointPose(y,n),f=this._getHandJoint(c,y);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],h=u.position.distanceTo(d.position),m=.02,x=.005;c.inputState.pinching&&h>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Pp)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new ar;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Dp=`
void main() {
...
}`;class Up{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new ht,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new hn({vertexShader:Dp,fragmentShader:Lp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new jt(new Bi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Ip extends xi{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,d=null,h=null,m=null,x=null;const y=new Up,p=t.getContextAttributes();let f=null,S=null;const _=[],v=[],R=new qe;let b=null;const A=new Wt;A.viewport=new st;const D=new Wt;D.viewport=new st;const T=[A,D],M=new eu;let C=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let ee=_[X];return ee===void 0&&(ee=new us,_[X]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(X){let ee=_[X];return ee===void 0&&(ee=new us,_[X]=ee),ee.getGripSpace()},this.getHand=function(X){let ee=_[X];return ee===void 0&&(ee=new us,_[X]=ee),ee.getHandSpace()};function z(X){const ee=v.indexOf(X.inputSource);if(ee===-1)return;const fe=_[ee];fe!==void 0&&(fe.update(X.inputSource,X.frame,c||o),fe.dispatchEvent({type:X.type,data:X.inputSource}))}function G(){r.removeEventListener("select",z),r.removeEventListener("selectstart",z),r.removeEventListener("selectend",z),r.removeEventListener("squeeze",z),r.removeEventListener("squeezestart",z),r.removeEventListener("squeezeend",z),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",Y);for(let X=0;X<_.length;X++){const ee=v[X];ee!==null&&(v[X]=null,_[X].disconnect(ee))}C=null,H=null,y.reset(),e.setRenderTarget(f),m=null,h=null,d=null,r=null,S=null,Ye.stop(),n.isPresenting=!1,e.setPixelRatio(b),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return d},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(f=e.getRenderTarget(),r.addEventListener("select",z),r.addEventListener("selectstart",z),r.addEventListener("selectend",z),r.addEventListener("squeeze",z),r.addEventListener("squeezestart",z),r.addEventListener("squeezeend",z),r.addEventListener("end",G),r.addEventListener("inputsourceschange",Y),p.xrCompatible!==!0&&await t.makeXRCompatible(),b=e.getPixelRatio(),e.getSize(R),r.enabledFeatures!==void 0&&r.enabledFeatures.includes("layers")){let fe=null,ne=null,Se=null;p.depth&&(Se=p.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=p.stencil?gi:ui,ne=p.stencil?mi:Vn);const Ae={colorFormat:t.RGBA8,depthFormat:Se,scaleFactor:s};d=new XRWebGLBinding(r,t),h=d.createProjectionLayer(Ae),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new Hn(h.textureWidth,h.textureHeight,{format:Nt,type:fn,depthTexture:new nl(h.textureWidth,h.textureHeight,ne,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1})}else{const fe={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,fe),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),S=new Hn(m.framebufferWidth,m.framebufferHeight,{format:Nt,type:fn,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Ye.setContext(r),Ye.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function Y(X){for(let ee=0;ee<X.removed.length;ee++){const fe=X.removed[ee],ne=v.indexOf(fe);ne>=0&&(v[ne]=null,_[ne].disconnect(fe))}for(let ee=0;ee<X.added.length;ee++){const fe=X.added[ee];let ne=v.indexOf(fe);if(ne===-1){for(let Ae=0;Ae<_.length;Ae++)if(Ae>=v.length){v.push(fe),ne=Ae;break}else if(v[Ae]===null){v[Ae]=fe,ne=Ae;break}if(ne===-1)break}const Se=_[ne];Se&&Se.connect(fe)}}const W=new V,j=new V;function N(X,ee,fe){W.setFromMatrixPosition(ee.matrixWorld),j.setFromMatrixPosition(fe.matrixWorld);const ne=W.distanceTo(j),Se=ee.projectionMatrix.elements,Ae=fe.projectionMatrix.elements,Pe=Se[14]/(Se[10]-1),Ke=Se[14]/(Se[10]+1),Fe=(Se[9]+1)/Se[5],Qe=(Se[9]-1)/Se[5],P=(Se[8]-1)/Se[0],Ct=(Ae[8]+1)/Ae[0],Oe=Pe*P,Be=Pe*Ct,Me=ne/(-P+Ct),et=Me*-P;if(ee.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(et),X.translateZ(Me),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Se[10]===-1)X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse);else{const xe=Pe+Me,w=Ke+Me,g=Oe-et,F=Be+(ne-et),$=Fe*Ke/w*xe,Z=Qe*Ke/w*xe;X.projectionMatrix.makePerspective(g,F,$,Z,xe,w),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function te(X,ee){ee===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(ee.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let ee=X.near,fe=X.far;y.texture!==null&&(y.depthNear>0&&(ee=y.depthNear),y.depthFar>0&&(fe=y.depthFar)),M.near=D.near=A.near=ee,M.far=D.far=A.far=fe,(C!==M.near||H!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),C=M.near,H=M.far),A.layers.mask=X.layers.mask|2,D.layers.mask=X.layers.mask|4,M.layers.mask=A.layers.mask|D.layers.mask;const ne=X.parent,Se=M.cameras;te(M,ne);for(let Ae=0;Ae<Se.length;Ae++)te(Se[Ae],ne);Se.length===2?N(M,A,D):M.projectionMatrix.copy(A.projectionMatrix),ae(X,M,ne)};function ae(X,ee,fe){fe===null?X.matrix.copy(ee.matrixWorld):(X.matrix.copy(fe.matrixWorld),X.matrix.invert(),X.matrix.multiply(ee.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Zs*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(X){l=X,h!==null&&(h.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(M)};let _e=null;function Te(X,ee){if(u=ee.getViewerPose(c||o),x=ee,u!==null){const fe=u.views;m!==null&&(e.setRenderTargetFramebuffer(S,m.framebuffer),e.setRenderTarget(S));let ne=!1;fe.length!==M.cameras.length&&(M.cameras.length=0,ne=!0);for(let Ae=0;Ae<fe.length;Ae++){const Pe=fe[Ae];let Ke=null;if(m!==null)Ke=m.getViewport(Pe);else{const Qe=d.getViewSubImage(h,Pe);Ke=Qe.viewport,Ae===0&&(e.setRenderTargetTextures(S,Qe.colorTexture,h.ignoreDepthValues?void 0:Qe.depthStencilTexture),e.setRenderTarget(S))}let Fe=T[Ae];Fe===void 0&&(Fe=new Wt,Fe.layers.enable(Ae),Fe.viewport=new st,T[Ae]=Fe),Fe.matrix.fromArray(Pe.transform.matrix),Fe.matrix.decompose(Fe.position,Fe.quaternion,Fe.scale),Fe.projectionMatrix.fromArray(Pe.projectionMatrix),Fe.projectionMatrixInverse.copy(Fe.projectionMatrix).invert(),Fe.viewport.set(Ke.x,Ke.y,Ke.width,Ke.height),Ae===0&&(M.matrix.copy(Fe.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),ne===!0&&M.cameras.push(Fe)}const Se=r.enabledFeatures;if(Se&&Se.includes("depth-sensing")){const Ae=d.getDepthInformation(fe[0]);Ae&&Ae.isValid&&Ae.texture&&y.init(e,Ae,r.renderState)}}for(let fe=0;fe<_.length;fe++){const ne=v[fe],Se=_[fe];ne!==null&&Se!==void 0&&Se.update(ne,ee,c||o)}_e&&_e(X,ee),ee.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ee}),x=null}const Ye=new rl;Ye.setAnimationLoop(Te),this.setAnimationLoop=function(X){_e=X},this.dispose=function(){}}}const Un=new dn,Fp=new lt;function Np(i,e){function t(p,f){p.matrixAutoUpdate===!0&&p.updateMatrix(),f.value.copy(p.matrix)}function n(p,f){f.color.getRGB(p.fogColor.value,Jo(i)),f.isFog?(p.fogNear.value=f.near,p.fogFar.value=f.far):f.isFogExp2&&(p.fogDensity.value=f.density)}function r(p,f,S,_,v){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(p,f):f.isMeshToonMaterial?(s(p,f),d(p,f)):f.isMeshPhongMaterial?(s(p,f),u(p,f)):f.isMeshStandardMaterial?(s(p,f),h(p,f),f.isMeshPhysicalMaterial&&m(p,f,v)):f.isMeshMatcapMaterial?(s(p,f),x(p,f)):f.isMeshDepthMaterial?s(p,f):f.isMeshDistanceMaterial?(s(p,f),y(p,f)):f.isMeshNormalMaterial?s(p,f):f.isLineBasicMaterial?(o(p,f),f.isLineDashedMaterial&&a(p,f)):f.isPointsMaterial?l(p,f,S,_):f.isSpriteMaterial?c(p,f):f.isShadowMaterial?(p.color.value.copy(f.color),p.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(p,f){p.opacity.value=f.opacity,f.color&&p.diffuse.value.copy(f.color),f.emissive&&p.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(p.map.value=f.map,t(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,t(f.alphaMap,p.alphaMapTransform)),f.bumpMap&&(p.bumpMap.value=f.bumpMap,t(f.bumpMap,p.bumpMapTransform),p.bumpScale.value=f.bumpScale,f.side===Tt&&(p.bumpScale.value*=-1)),f.normalMap&&(p.normalMap.value=f.normalMap,t(f.normalMap,p.normalMapTransform),p.normalScale.value.copy(f.normalScale),f.side===Tt&&p.normalScale.value.negate()),f.displacementMap&&(p.displacementMap.value=f.displacementMap,t(f.displacementMap,p.displacementMapTransform),p.displacementScale.value=f.displacementScale,p.displacementBias.value=f.displacementBias),f.emissiveMap&&(p.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,p.emissiveMapTransform)),f.specularMap&&(p.specularMap.value=f.specularMap,t(f.specularMap,p.specularMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest);const S=e.get(f),_=S.envMap,v=S.envMapRotation;_&&(p.envMap.value=_,Un.copy(v),Un.x*=-1,Un.y*=-1,Un.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Un.y*=-1,Un.z*=-1),p.envMapRotation.value.setFromMatrix4(Fp.makeRotationFromEuler(Un)),p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=f.reflectivity,p.ior.value=f.ior,p.refractionRatio.value=f.refractionRatio),f.lightMap&&(p.lightMap.value=f.lightMap,p.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,p.lightMapTransform)),f.aoMap&&(p.aoMap.value=f.aoMap,p.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,p.aoMapTransform))}function o(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,f.map&&(p.map.value=f.map,t(f.map,p.mapTransform))}function a(p,f){p.dashSize.value=f.dashSize,p.totalSize.value=f.dashSize+f.gapSize,p.scale.value=f.scale}function l(p,f,S,_){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.size.value=f.size*S,p.scale.value=_*.5,f.map&&(p.map.value=f.map,t(f.map,p.uvTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,t(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function c(p,f){p.diffuse.value.copy(f.color),p.opacity.value=f.opacity,p.rotation.value=f.rotation,f.map&&(p.map.value=f.map,t(f.map,p.mapTransform)),f.alphaMap&&(p.alphaMap.value=f.alphaMap,t(f.alphaMap,p.alphaMapTransform)),f.alphaTest>0&&(p.alphaTest.value=f.alphaTest)}function u(p,f){p.specular.value.copy(f.specular),p.shininess.value=Math.max(f.shininess,1e-4)}function d(p,f){f.gradientMap&&(p.gradientMap.value=f.gradientMap)}function h(p,f){p.metalness.value=f.metalness,f.metalnessMap&&(p.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,p.metalnessMapTransform)),p.roughness.value=f.roughness,f.roughnessMap&&(p.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,p.roughnessMapTransform)),f.envMap&&(p.envMapIntensity.value=f.envMapIntensity)}function m(p,f,S){p.ior.value=f.ior,f.sheen>0&&(p.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),p.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(p.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,p.sheenColorMapTransform)),f.sheenRoughnessMap&&(p.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,p.sheenRoughnessMapTransform))),f.clearcoat>0&&(p.clearcoat.value=f.clearcoat,p.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(p.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,p.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(p.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Tt&&p.clearcoatNormalScale.value.negate())),f.dispersion>0&&(p.dispersion.value=f.dispersion),f.iridescence>0&&(p.iridescence.value=f.iridescence,p.iridescenceIOR.value=f.iridescenceIOR,p.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(p.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,p.iridescenceMapTransform)),f.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),f.transmission>0&&(p.transmission.value=f.transmission,p.transmissionSamplerMap.value=S.texture,p.transmissionSamplerSize.value.set(S.width,S.height),f.transmissionMap&&(p.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,p.transmissionMapTransform)),p.thickness.value=f.thickness,f.thicknessMap&&(p.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=f.attenuationDistance,p.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(p.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(p.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=f.specularIntensity,p.specularColor.value.copy(f.specularColor),f.specularColorMap&&(p.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,p.specularColorMapTransform)),f.specularIntensityMap&&(p.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,f){f.matcap&&(p.matcap.value=f.matcap)}function y(p,f){const S=e.get(f).light;p.referencePosition.value.setFromMatrixPosition(S.matrixWorld),p.nearDistance.value=S.shadow.camera.near,p.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Op(i,e,t,n){let r={},s={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,_){const v=_.program;n.uniformBlockBinding(S,v)}function c(S,_){let v=r[S.id];v===void 0&&(x(S),v=u(S),r[S.id]=v,S.addEventListener("dispose",p));const R=_.program;n.updateUBOMapping(S,R);const b=e.render.frame;s[S.id]!==b&&(h(S),s[S.id]=b)}function u(S){const _=d();S.__bindingPointIndex=_;const v=i.createBuffer(),R=S.__size,b=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,v),i.bufferData(i.UNIFORM_BUFFER,R,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,_,v),v}function d(){for(let S=0;S<a;S++)if(o.indexOf(S)===-1)return o.push(S),S;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){const _=r[S.id],v=S.uniforms,R=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,_);for(let b=0,A=v.length;b<A;b++){const D=Array.isArray(v[b])?v[b]:[v[b]];for(let T=0,M=D.length;T<M;T++){const C=D[T];if(m(C,b,T,R)===!0){const H=C.__offset,z=Array.isArray(C.value)?C.value:[C.value];let G=0;for(let Y=0;Y<z.length;Y++){const W=z[Y],j=y(W);typeof W=="number"||typeof W=="boolean"?(C.__data[0]=W,i.bufferSubData(i.UNIFORM_BUFFER,H+G,C.__data)):W.isMatrix3?(C.__data[0]=W.elements[0],C.__data[1]=W.elements[1],C.__data[2]=W.elements[2],C.__data[3]=0,C.__data[4]=W.elements[3],C.__data[5]=W.elements[4],C.__data[6]=W.elements[5],C.__data[7]=0,C.__data[8]=W.elements[6],C.__data[9]=W.elements[7],C.__data[10]=W.elements[8],C.__data[11]=0):(W.toArray(C.__data,G),G+=j.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,H,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(S,_,v,R){const b=S.value,A=_+"_"+v;if(R[A]===void 0)return typeof b=="number"||typeof b=="boolean"?R[A]=b:R[A]=b.clone(),!0;{const D=R[A];if(typeof b=="number"||typeof b=="boolean"){if(D!==b)return R[A]=b,!0}else if(D.equals(b)===!1)return D.copy(b),!0}return!1}function x(S){const _=S.uniforms;let v=0;const R=16;for(let A=0,D=_.length;A<D;A++){const T=Array.isArray(_[A])?_[A]:[_[A]];for(let M=0,C=T.length;M<C;M++){const H=T[M],z=Array.isArray(H.value)?H.value:[H.value];for(let G=0,Y=z.length;G<Y;G++){const W=z[G],j=y(W),N=v%R,te=N%j.boundary,ae=N+te;v+=te,ae!==0&&R-ae<j.storage&&(v+=R-ae),H.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=v,v+=j.storage}}}const b=v%R;return b>0&&(v+=R-b),S.__size=v,S.__cache={},this}function y(S){const _={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(_.boundary=4,_.storage=4):S.isVector2?(_.boundary=8,_.storage=8):S.isVector3||S.isColor?(_.boundary=16,_.storage=12):S.isVector4?(_.boundary=16,_.storage=16):S.isMatrix3?(_.boundary=48,_.storage=48):S.isMatrix4?(_.boundary=64,_.storage=64):S.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",S),_}function p(S){const _=S.target;_.removeEventListener("dispose",p);const v=o.indexOf(_.__bindingPointIndex);o.splice(v,1),i.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function f(){for(const S in r)i.deleteBuffer(r[S]);o=[],r={},s={}}return{bind:l,update:c,dispose:f}}class Bp{constructor(e={}){const{canvas:t=_c(),context:n=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:h=!1}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=o;const x=new Uint32Array(4),y=new Int32Array(4);let p=null,f=null;const S=[],_=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=It,this.toneMapping=yn,this.toneMappingExposure=1;const v=this;let R=!1,b=0,A=0,D=null,T=-1,M=null;const C=new st,H=new st;let z=null;const G=new je(0);let Y=0,W=t.width,j=t.height,N=1,te=null,ae=null;const _e=new st(0,0,W,j),Te=new st(0,0,W,j);let Ye=!1;const X=new tl;let ee=!1,fe=!1;this.transmissionResolutionScale=1;const ne=new lt,Se=new lt,Ae=new V,Pe=new st,Ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Fe=!1;function Qe(){return D===null?N:1}let P=n;function Ct(E,U){return t.getContext(E,U)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ta}`),t.addEventListener("webglcontextlost",K,!1),t.addEventListener("webglcontextrestored",ce,!1),t.addEventListener("webglcontextcreationerror",le,!1),P===null){const U="webgl2";if(P=Ct(U,E),P===null)throw Ct(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let Oe,Be,Me,et,xe,w,g,F,$,Z,q,ve,oe,de,Ve,Q,pe,be,we,me,ze,Ue,Je,L;function re(){Oe=new Yd(P),Oe.init(),Ue=new Cp(P,Oe),Be=new Hd(P,Oe,e,Ue),Me=new wp(P,Oe),Be.reverseDepthBuffer&&h&&Me.buffers.depth.setReversed(!0),et=new Zd(P),xe=new pp,w=new Rp(P,Oe,Me,xe,Be,Ue,et),g=new kd(v),F=new qd(v),$=new nu(P),Je=new zd(P,$),Z=new $d(P,$,et,Je),q=new Jd(P,Z,$,et),we=new jd(P,Be,w),Q=new Gd(xe),ve=new hp(v,g,F,Oe,Be,Je,Q),oe=new Np(v,xe),de=new gp,Ve=new Ep(Oe),be=new Bd(v,g,F,Me,q,m,l),pe=new bp(v,q,Be),L=new Op(P,et,Be,Me),me=new Vd(P,Oe,et),ze=new Kd(P,Oe,et),et.programs=ve.programs,v.capabilities=Be,v.extensions=Oe,v.properties=xe,v.renderLists=de,v.shadowMap=pe,v.state=Me,v.info=et}re();const k=new Ip(v,P);this.xr=k,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const E=Oe.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=Oe.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return N},this.setPixelRatio=function(E){E!==void 0&&(N=E,this.setSize(W,j,!1))},this.getSize=function(E){return E.set(W,j)},this.setSize=function(E,U,O=!0){if(k.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=E,j=U,t.width=Math.floor(E*N),t.height=Math.floor(U*N),O===!0&&(t.style.width=E+"px",t.style.height=U+"px"),this.setViewport(0,0,E,U)},this.getDrawingBufferSize=function(E){return E.set(W*N,j*N).floor()},this.setDrawingBufferSize=function(E,U,O){W=E,j=U,N=O,t.width=Math.floor(E*O),t.height=Math.floor(U*O),this.setViewport(0,0,E,U)},this.getCurrentViewport=function(E){return E.copy(C)},this.getViewport=function(E){return E.copy(_e)},this.setViewport=function(E,U,O,B){E.isVector4?_e.set(E.x,E.y,E.z,E.w):_e.set(E,U,O,B),Me.viewport(C.copy(_e).multiplyScalar(N).round())},this.getScissor=function(E){return E.copy(Te)},this.setScissor=function(E,U,O,B){E.isVector4?Te.set(E.x,E.y,E.z,E.w):Te.set(E,U,O,B),Me.scissor(H.copy(Te).multiplyScalar(N).round())},this.getScissorTest=function(){return Ye},this.setScissorTest=function(E){Me.setScissorTest(Ye=E)},this.setOpaqueSort=function(E){te=E},this.setTransparentSort=function(E){ae=E},this.getClearColor=function(E){return E.copy(be.getClearColor())},this.setClearColor=function(){be.setClearColor.apply(be,arguments)},this.getClearAlpha=function(){return be.getClearAlpha()},this.setClearAlpha=function(){be.setClearAlpha.apply(be,arguments)},this.clear=function(E=!0,U=!0,O=!0){let B=0;if(E){let I=!1;if(D!==null){const J=D.texture.format;I=J===oa||J===aa||J===sa}if(I){const J=D.texture.type,se=J===fn||J===Vn||J===Di||J===mi||J===ia||J===ra,ue=be.getClearColor(),ge=be.getClearAlpha(),Re=ue.r,Ce=ue.g,Ee=ue.b;se?(x[0]=Re,x[1]=Ce,x[2]=Ee,x[3]=ge,P.clearBufferuiv(P.COLOR,0,x)):(y[0]=Re,y[1]=Ce,y[2]=Ee,y[3]=ge,P.clearBufferiv(P.COLOR,0,y))}else B|=P.COLOR_BUFFER_BIT}U&&(B|=P.DEPTH_BUFFER_BIT),O&&(B|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",K,!1),t.removeEventListener("webglcontextrestored",ce,!1),t.removeEventListener("webglcontextcreationerror",le,!1),be.dispose(),de.dispose(),Ve.dispose(),xe.dispose(),g.dispose(),F.dispose(),q.dispose(),Je.dispose(),L.dispose(),ve.dispose(),k.dispose(),k.removeEventListener("sessionstart",pa),k.removeEventListener("sessionend",ma),An.stop()};function K(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function ce(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const E=et.autoReset,U=pe.enabled,O=pe.autoUpdate,B=pe.needsUpdate,I=pe.type;re(),et.autoReset=E,pe.enabled=U,pe.autoUpdate=O,pe.needsUpdate=B,pe.type=I}function le(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function De(E){const U=E.target;U.removeEventListener("dispose",De),it(U)}function it(E){mt(E),xe.remove(E)}function mt(E){const U=xe.get(E).programs;U!==void 0&&(U.forEach(function(O){ve.releaseProgram(O)}),E.isShaderMaterial&&ve.releaseShaderCache(E))}this.renderBufferDirect=function(E,U,O,B,I,J){U===null&&(U=Ke);const se=I.isMesh&&I.matrixWorld.determinant()<0,ue=Ml(E,U,O,B,I);Me.setMaterial(B,se);let ge=O.index,Re=1;if(B.wireframe===!0){if(ge=Z.getWireframeAttribute(O),ge===void 0)return;Re=2}const Ce=O.drawRange,Ee=O.attributes.position;let He=Ce.start*Re,We=(Ce.start+Ce.count)*Re;J!==null&&(He=Math.max(He,J.start*Re),We=Math.min(We,(J.start+J.count)*Re)),ge!==null?(He=Math.max(He,0),We=Math.min(We,ge.count)):Ee!=null&&(He=Math.max(He,0),We=Math.min(We,Ee.count));const at=We-He;if(at<0||at===1/0)return;Je.setup(I,B,ue,O,ge);let rt,Ge=me;if(ge!==null&&(rt=$.get(ge),Ge=ze,Ge.setIndex(rt)),I.isMesh)B.wireframe===!0?(Me.setLineWidth(B.wireframeLinewidth*Qe()),Ge.setMode(P.LINES)):Ge.setMode(P.TRIANGLES);else if(I.isLine){let ye=B.linewidth;ye===void 0&&(ye=1),Me.setLineWidth(ye*Qe()),I.isLineSegments?Ge.setMode(P.LINES):I.isLineLoop?Ge.setMode(P.LINE_LOOP):Ge.setMode(P.LINE_STRIP)}else I.isPoints?Ge.setMode(P.POINTS):I.isSprite&&Ge.setMode(P.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)Ge.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Oe.get("WEBGL_multi_draw"))Ge.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const ye=I._multiDrawStarts,pt=I._multiDrawCounts,Xe=I._multiDrawCount,Bt=ge?$.get(ge).bytesPerElement:1,kn=xe.get(B).currentProgram.getUniforms();for(let bt=0;bt<Xe;bt++)kn.setValue(P,"_gl_DrawID",bt),Ge.render(ye[bt]/Bt,pt[bt])}else if(I.isInstancedMesh)Ge.renderInstances(He,at,I.count);else if(O.isInstancedBufferGeometry){const ye=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,pt=Math.min(O.instanceCount,ye);Ge.renderInstances(He,at,pt)}else Ge.render(He,at)};function $e(E,U,O){E.transparent===!0&&E.side===on&&E.forceSinglePass===!1?(E.side=Tt,E.needsUpdate=!0,Hi(E,U,O),E.side=Tn,E.needsUpdate=!0,Hi(E,U,O),E.side=on):Hi(E,U,O)}this.compile=function(E,U,O=null){O===null&&(O=E),f=Ve.get(O),f.init(U),_.push(f),O.traverseVisible(function(I){I.isLight&&I.layers.test(U.layers)&&(f.pushLight(I),I.castShadow&&f.pushShadow(I))}),E!==O&&E.traverseVisible(function(I){I.isLight&&I.layers.test(U.layers)&&(f.pushLight(I),I.castShadow&&f.pushShadow(I))}),f.setupLights();const B=new Set;return E.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const J=I.material;if(J)if(Array.isArray(J))for(let se=0;se<J.length;se++){const ue=J[se];$e(ue,O,I),B.add(ue)}else $e(J,O,I),B.add(J)}),_.pop(),f=null,B},this.compileAsync=function(E,U,O=null){const B=this.compile(E,U,O);return new Promise(I=>{function J(){if(B.forEach(function(se){xe.get(se).currentProgram.isReady()&&B.delete(se)}),B.size===0){I(E);return}setTimeout(J,10)}Oe.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let Ot=null;function Qt(E){Ot&&Ot(E)}function pa(){An.stop()}function ma(){An.start()}const An=new rl;An.setAnimationLoop(Qt),typeof self<"u"&&An.setContext(self),this.setAnimationLoop=function(E){Ot=E,k.setAnimationLoop(E),E===null?An.stop():An.start()},k.addEventListener("sessionstart",pa),k.addEventListener("sessionend",ma),this.render=function(E,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),k.enabled===!0&&k.isPresenting===!0&&(k.cameraAutoUpdate===!0&&k.updateCamera(U),U=k.getCamera()),E.isScene===!0&&E.onBeforeRender(v,E,U,D),f=Ve.get(E,_.length),f.init(U),_.push(f),Se.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),X.setFromProjectionMatrix(Se),fe=this.localClippingEnabled,ee=Q.init(this.clippingPlanes,fe),p=de.get(E,S.length),p.init(),S.push(p),k.enabled===!0&&k.isPresenting===!0){const J=v.xr.getDepthSensingMesh();J!==null&&Ur(J,U,-1/0,v.sortObjects)}Ur(E,U,0,v.sortObjects),p.finish(),v.sortObjects===!0&&p.sort(te,ae),Fe=k.enabled===!1||k.isPresenting===!1||k.hasDepthSensing()===!1,Fe&&be.addToRenderList(p,E),this.info.render.frame++,ee===!0&&Q.beginShadows();const O=f.state.shadowsArray;pe.render(O,E,U),ee===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const B=p.opaque,I=p.transmissive;if(f.setupLights(),U.isArrayCamera){const J=U.cameras;if(I.length>0)for(let se=0,ue=J.length;se<ue;se++){const ge=J[se];_a(B,I,E,ge)}Fe&&be.render(E);for(let se=0,ue=J.length;se<ue;se++){const ge=J[se];ga(p,E,ge,ge.viewport)}}else I.length>0&&_a(B,I,E,U),Fe&&be.render(E),ga(p,E,U);D!==null&&A===0&&(w.updateMultisampleRenderTarget(D),w.updateRenderTargetMipmap(D)),E.isScene===!0&&E.onAfterRender(v,E,U),Je.resetDefaultState(),T=-1,M=null,_.pop(),_.length>0?(f=_[_.length-1],ee===!0&&Q.setGlobalState(v.clippingPlanes,f.state.camera)):f=null,S.pop(),S.length>0?p=S[S.length-1]:p=null};function Ur(E,U,O,B){if(E.visible===!1)return;if(E.layers.test(U.layers)){if(E.isGroup)O=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(U);else if(E.isLight)f.pushLight(E),E.castShadow&&f.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||X.intersectsSprite(E)){B&&Pe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Se);const se=q.update(E),ue=E.material;ue.visible&&p.push(E,se,ue,O,Pe.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||X.intersectsObject(E))){const se=q.update(E),ue=E.material;if(B&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Pe.copy(E.boundingSphere.center)):(se.boundingSphere===null&&se.computeBoundingSphere(),Pe.copy(se.boundingSphere.center)),Pe.applyMatrix4(E.matrixWorld).applyMatrix4(Se)),Array.isArray(ue)){const ge=se.groups;for(let Re=0,Ce=ge.length;Re<Ce;Re++){const Ee=ge[Re],He=ue[Ee.materialIndex];He&&He.visible&&p.push(E,se,He,O,Pe.z,Ee)}}else ue.visible&&p.push(E,se,ue,O,Pe.z,null)}}const J=E.children;for(let se=0,ue=J.length;se<ue;se++)Ur(J[se],U,O,B)}function ga(E,U,O,B){const I=E.opaque,J=E.transmissive,se=E.transparent;f.setupLightsView(O),ee===!0&&Q.setGlobalState(v.clippingPlanes,O),B&&Me.viewport(C.copy(B)),I.length>0&&Vi(I,U,O),J.length>0&&Vi(J,U,O),se.length>0&&Vi(se,U,O),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function _a(E,U,O,B){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[B.id]===void 0&&(f.state.transmissionRenderTarget[B.id]=new Hn(1,1,{generateMipmaps:!0,type:Oe.has("EXT_color_buffer_half_float")||Oe.has("EXT_color_buffer_float")?Ui:fn,minFilter:Bn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ke.workingColorSpace}));const J=f.state.transmissionRenderTarget[B.id],se=B.viewport||C;J.setSize(se.z*v.transmissionResolutionScale,se.w*v.transmissionResolutionScale);const ue=v.getRenderTarget();v.setRenderTarget(J),v.getClearColor(G),Y=v.getClearAlpha(),Y<1&&v.setClearColor(16777215,.5),v.clear(),Fe&&be.render(O);const ge=v.toneMapping;v.toneMapping=yn;const Re=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),f.setupLightsView(B),ee===!0&&Q.setGlobalState(v.clippingPlanes,B),Vi(E,O,B),w.updateMultisampleRenderTarget(J),w.updateRenderTargetMipmap(J),Oe.has("WEBGL_multisampled_render_to_texture")===!1){let Ce=!1;for(let Ee=0,He=U.length;Ee<He;Ee++){const We=U[Ee],at=We.object,rt=We.geometry,Ge=We.material,ye=We.group;if(Ge.side===on&&at.layers.test(B.layers)){const pt=Ge.side;Ge.side=Tt,Ge.needsUpdate=!0,va(at,O,B,rt,Ge,ye),Ge.side=pt,Ge.needsUpdate=!0,Ce=!0}}Ce===!0&&(w.updateMultisampleRenderTarget(J),w.updateRenderTargetMipmap(J))}v.setRenderTarget(ue),v.setClearColor(G,Y),Re!==void 0&&(B.viewport=Re),v.toneMapping=ge}function Vi(E,U,O){const B=U.isScene===!0?U.overrideMaterial:null;for(let I=0,J=E.length;I<J;I++){const se=E[I],ue=se.object,ge=se.geometry,Re=B===null?se.material:B,Ce=se.group;ue.layers.test(O.layers)&&va(ue,U,O,ge,Re,Ce)}}function va(E,U,O,B,I,J){E.onBeforeRender(v,U,O,B,I,J),E.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),I.onBeforeRender(v,U,O,B,E,J),I.transparent===!0&&I.side===on&&I.forceSinglePass===!1?(I.side=Tt,I.needsUpdate=!0,v.renderBufferDirect(O,U,B,I,E,J),I.side=Tn,I.needsUpdate=!0,v.renderBufferDirect(O,U,B,I,E,J),I.side=on):v.renderBufferDirect(O,U,B,I,E,J),E.onAfterRender(v,U,O,B,I,J)}function Hi(E,U,O){U.isScene!==!0&&(U=Ke);const B=xe.get(E),I=f.state.lights,J=f.state.shadowsArray,se=I.state.version,ue=ve.getParameters(E,I.state,J,U,O),ge=ve.getProgramCacheKey(ue);let Re=B.programs;B.environment=E.isMeshStandardMaterial?U.environment:null,B.fog=U.fog,B.envMap=(E.isMeshStandardMaterial?F:g).get(E.envMap||B.environment),B.envMapRotation=B.environment!==null&&E.envMap===null?U.environmentRotation:E.envMapRotation,Re===void 0&&(E.addEventListener("dispose",De),Re=new Map,B.programs=Re);let Ce=Re.get(ge);if(Ce!==void 0){if(B.currentProgram===Ce&&B.lightsStateVersion===se)return Ma(E,ue),Ce}else ue.uniforms=ve.getUniforms(E),E.onBeforeCompile(ue,v),Ce=ve.acquireProgram(ue,ge),Re.set(ge,Ce),B.uniforms=ue.uniforms;const Ee=B.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ee.clippingPlanes=Q.uniform),Ma(E,ue),B.needsLights=El(E),B.lightsStateVersion=se,B.needsLights&&(Ee.ambientLightColor.value=I.state.ambient,Ee.lightProbe.value=I.state.probe,Ee.directionalLights.value=I.state.directional,Ee.directionalLightShadows.value=I.state.directionalShadow,Ee.spotLights.value=I.state.spot,Ee.spotLightShadows.value=I.state.spotShadow,Ee.rectAreaLights.value=I.state.rectArea,Ee.ltc_1.value=I.state.rectAreaLTC1,Ee.ltc_2.value=I.state.rectAreaLTC2,Ee.pointLights.value=I.state.point,Ee.pointLightShadows.value=I.state.pointShadow,Ee.hemisphereLights.value=I.state.hemi,Ee.directionalShadowMap.value=I.state.directionalShadowMap,Ee.directionalShadowMatrix.value=I.state.directionalShadowMatrix,Ee.spotShadowMap.value=I.state.spotShadowMap,Ee.spotLightMatrix.value=I.state.spotLightMatrix,Ee.spotLightMap.value=I.state.spotLightMap,Ee.pointShadowMap.value=I.state.pointShadowMap,Ee.pointShadowMatrix.value=I.state.pointShadowMatrix),B.currentProgram=Ce,B.uniformsList=null,Ce}function xa(E){if(E.uniformsList===null){const U=E.currentProgram.getUniforms();E.uniformsList=vr.seqWithValue(U.seq,E.uniforms)}return E.uniformsList}function Ma(E,U){const O=xe.get(E);O.outputColorSpace=U.outputColorSpace,O.batching=U.batching,O.batchingColor=U.batchingColor,O.instancing=U.instancing,O.instancingColor=U.instancingColor,O.instancingMorph=U.instancingMorph,O.skinning=U.skinning,O.morphTargets=U.morphTargets,O.morphNormals=U.morphNormals,O.morphColors=U.morphColors,O.morphTargetsCount=U.morphTargetsCount,O.numClippingPlanes=U.numClippingPlanes,O.numIntersection=U.numClipIntersection,O.vertexAlphas=U.vertexAlphas,O.vertexTangents=U.vertexTangents,O.toneMapping=U.toneMapping}function Ml(E,U,O,B,I){U.isScene!==!0&&(U=Ke),w.resetTextureUnits();const J=U.fog,se=B.isMeshStandardMaterial?U.environment:null,ue=D===null?v.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:_i,ge=(B.isMeshStandardMaterial?F:g).get(B.envMap||se),Re=B.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,Ce=!!O.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Ee=!!O.morphAttributes.position,He=!!O.morphAttributes.normal,We=!!O.morphAttributes.color;let at=yn;B.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(at=v.toneMapping);const rt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,Ge=rt!==void 0?rt.length:0,ye=xe.get(B),pt=f.state.lights;if(ee===!0&&(fe===!0||E!==M)){const xt=E===M&&B.id===T;Q.setState(B,E,xt)}let Xe=!1;B.version===ye.__version?(ye.needsLights&&ye.lightsStateVersion!==pt.state.version||ye.outputColorSpace!==ue||I.isBatchedMesh&&ye.batching===!1||!I.isBatchedMesh&&ye.batching===!0||I.isBatchedMesh&&ye.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&ye.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&ye.instancing===!1||!I.isInstancedMesh&&ye.instancing===!0||I.isSkinnedMesh&&ye.skinning===!1||!I.isSkinnedMesh&&ye.skinning===!0||I.isInstancedMesh&&ye.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&ye.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&ye.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&ye.instancingMorph===!1&&I.morphTexture!==null||ye.envMap!==ge||B.fog===!0&&ye.fog!==J||ye.numClippingPlanes!==void 0&&(ye.numClippingPlanes!==Q.numPlanes||ye.numIntersection!==Q.numIntersection)||ye.vertexAlphas!==Re||ye.vertexTangents!==Ce||ye.morphTargets!==Ee||ye.morphNormals!==He||ye.morphColors!==We||ye.toneMapping!==at||ye.morphTargetsCount!==Ge)&&(Xe=!0):(Xe=!0,ye.__version=B.version);let Bt=ye.currentProgram;Xe===!0&&(Bt=Hi(B,U,I));let kn=!1,bt=!1,Si=!1;const tt=Bt.getUniforms(),Pt=ye.uniforms;if(Me.useProgram(Bt.program)&&(kn=!0,bt=!0,Si=!0),B.id!==T&&(T=B.id,bt=!0),kn||M!==E){Me.buffers.depth.getReversed()?(ne.copy(E.projectionMatrix),xc(ne),Mc(ne),tt.setValue(P,"projectionMatrix",ne)):tt.setValue(P,"projectionMatrix",E.projectionMatrix),tt.setValue(P,"viewMatrix",E.matrixWorldInverse);const St=tt.map.cameraPosition;St!==void 0&&St.setValue(P,Ae.setFromMatrixPosition(E.matrixWorld)),Be.logarithmicDepthBuffer&&tt.setValue(P,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&tt.setValue(P,"isOrthographic",E.isOrthographicCamera===!0),M!==E&&(M=E,bt=!0,Si=!0)}if(I.isSkinnedMesh){tt.setOptional(P,I,"bindMatrix"),tt.setOptional(P,I,"bindMatrixInverse");const xt=I.skeleton;xt&&(xt.boneTexture===null&&xt.computeBoneTexture(),tt.setValue(P,"boneTexture",xt.boneTexture,w))}I.isBatchedMesh&&(tt.setOptional(P,I,"batchingTexture"),tt.setValue(P,"batchingTexture",I._matricesTexture,w),tt.setOptional(P,I,"batchingIdTexture"),tt.setValue(P,"batchingIdTexture",I._indirectTexture,w),tt.setOptional(P,I,"batchingColorTexture"),I._colorsTexture!==null&&tt.setValue(P,"batchingColorTexture",I._colorsTexture,w));const Dt=O.morphAttributes;if((Dt.position!==void 0||Dt.normal!==void 0||Dt.color!==void 0)&&we.update(I,O,Bt),(bt||ye.receiveShadow!==I.receiveShadow)&&(ye.receiveShadow=I.receiveShadow,tt.setValue(P,"receiveShadow",I.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(Pt.envMap.value=ge,Pt.flipEnvMap.value=ge.isCubeTexture&&ge.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&U.environment!==null&&(Pt.envMapIntensity.value=U.environmentIntensity),bt&&(tt.setValue(P,"toneMappingExposure",v.toneMappingExposure),ye.needsLights&&Sl(Pt,Si),J&&B.fog===!0&&oe.refreshFogUniforms(Pt,J),oe.refreshMaterialUniforms(Pt,B,N,j,f.state.transmissionRenderTarget[E.id]),vr.upload(P,xa(ye),Pt,w)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(vr.upload(P,xa(ye),Pt,w),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&tt.setValue(P,"center",I.center),tt.setValue(P,"modelViewMatrix",I.modelViewMatrix),tt.setValue(P,"normalMatrix",I.normalMatrix),tt.setValue(P,"modelMatrix",I.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const xt=B.uniformsGroups;for(let St=0,Ir=xt.length;St<Ir;St++){const wn=xt[St];L.update(wn,Bt),L.bind(wn,Bt)}}return Bt}function Sl(E,U){E.ambientLightColor.needsUpdate=U,E.lightProbe.needsUpdate=U,E.directionalLights.needsUpdate=U,E.directionalLightShadows.needsUpdate=U,E.pointLights.needsUpdate=U,E.pointLightShadows.needsUpdate=U,E.spotLights.needsUpdate=U,E.spotLightShadows.needsUpdate=U,E.rectAreaLights.needsUpdate=U,E.hemisphereLights.needsUpdate=U}function El(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(E,U,O){xe.get(E.texture).__webglTexture=U,xe.get(E.depthTexture).__webglTexture=O;const B=xe.get(E);B.__hasExternalTextures=!0,B.__autoAllocateDepthBuffer=O===void 0,B.__autoAllocateDepthBuffer||Oe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),B.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(E,U){const O=xe.get(E);O.__webglFramebuffer=U,O.__useDefaultFramebuffer=U===void 0};const yl=P.createFramebuffer();this.setRenderTarget=function(E,U=0,O=0){D=E,b=U,A=O;let B=!0,I=null,J=!1,se=!1;if(E){const ge=xe.get(E);if(ge.__useDefaultFramebuffer!==void 0)Me.bindFramebuffer(P.FRAMEBUFFER,null),B=!1;else if(ge.__webglFramebuffer===void 0)w.setupRenderTarget(E);else if(ge.__hasExternalTextures)w.rebindTextures(E,xe.get(E.texture).__webglTexture,xe.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Ee=E.depthTexture;if(ge.__boundDepthTexture!==Ee){if(Ee!==null&&xe.has(Ee)&&(E.width!==Ee.image.width||E.height!==Ee.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(E)}}const Re=E.texture;(Re.isData3DTexture||Re.isDataArrayTexture||Re.isCompressedArrayTexture)&&(se=!0);const Ce=xe.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ce[U])?I=Ce[U][O]:I=Ce[U],J=!0):E.samples>0&&w.useMultisampledRTT(E)===!1?I=xe.get(E).__webglMultisampledFramebuffer:Array.isArray(Ce)?I=Ce[O]:I=Ce,C.copy(E.viewport),H.copy(E.scissor),z=E.scissorTest}else C.copy(_e).multiplyScalar(N).floor(),H.copy(Te).multiplyScalar(N).floor(),z=Ye;if(O!==0&&(I=yl),Me.bindFramebuffer(P.FRAMEBUFFER,I)&&B&&Me.drawBuffers(E,I),Me.viewport(C),Me.scissor(H),Me.setScissorTest(z),J){const ge=xe.get(E.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+U,ge.__webglTexture,O)}else if(se){const ge=xe.get(E.texture),Re=U;P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,ge.__webglTexture,O,Re)}else if(E!==null&&O!==0){const ge=xe.get(E.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,ge.__webglTexture,O)}T=-1},this.readRenderTargetPixels=function(E,U,O,B,I,J,se){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ue=xe.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&se!==void 0&&(ue=ue[se]),ue){Me.bindFramebuffer(P.FRAMEBUFFER,ue);try{const ge=E.texture,Re=ge.format,Ce=ge.type;if(!Be.textureFormatReadable(Re)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Be.textureTypeReadable(Ce)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=E.width-B&&O>=0&&O<=E.height-I&&P.readPixels(U,O,B,I,Ue.convert(Re),Ue.convert(Ce),J)}finally{const ge=D!==null?xe.get(D).__webglFramebuffer:null;Me.bindFramebuffer(P.FRAMEBUFFER,ge)}}},this.readRenderTargetPixelsAsync=async function(E,U,O,B,I,J,se){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ue=xe.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&se!==void 0&&(ue=ue[se]),ue){const ge=E.texture,Re=ge.format,Ce=ge.type;if(!Be.textureFormatReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Be.textureTypeReadable(Ce))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(U>=0&&U<=E.width-B&&O>=0&&O<=E.height-I){Me.bindFramebuffer(P.FRAMEBUFFER,ue);const Ee=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Ee),P.bufferData(P.PIXEL_PACK_BUFFER,J.byteLength,P.STREAM_READ),P.readPixels(U,O,B,I,Ue.convert(Re),Ue.convert(Ce),0);const He=D!==null?xe.get(D).__webglFramebuffer:null;Me.bindFramebuffer(P.FRAMEBUFFER,He);const We=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await vc(P,We,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Ee),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,J),P.deleteBuffer(Ee),P.deleteSync(We),J}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(E,U=null,O=0){E.isTexture!==!0&&(si("WebGLRenderer: copyFramebufferToTexture function signature has changed."),U=arguments[0]||null,E=arguments[1]);const B=Math.pow(2,-O),I=Math.floor(E.image.width*B),J=Math.floor(E.image.height*B),se=U!==null?U.x:0,ue=U!==null?U.y:0;w.setTexture2D(E,0),P.copyTexSubImage2D(P.TEXTURE_2D,O,0,0,se,ue,I,J),Me.unbindTexture()};const Tl=P.createFramebuffer(),bl=P.createFramebuffer();this.copyTextureToTexture=function(E,U,O=null,B=null,I=0,J=null){E.isTexture!==!0&&(si("WebGLRenderer: copyTextureToTexture function signature has changed."),B=arguments[0]||null,E=arguments[1],U=arguments[2],J=arguments[3]||0,O=null),J===null&&(I!==0?(si("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),J=I,I=0):J=0);let se,ue,ge,Re,Ce,Ee,He,We,at;const rt=E.isCompressedTexture?E.mipmaps[J]:E.image;if(O!==null)se=O.max.x-O.min.x,ue=O.max.y-O.min.y,ge=O.isBox3?O.max.z-O.min.z:1,Re=O.min.x,Ce=O.min.y,Ee=O.isBox3?O.min.z:0;else{const Dt=Math.pow(2,-I);se=Math.floor(rt.width*Dt),ue=Math.floor(rt.height*Dt),E.isDataArrayTexture?ge=rt.depth:E.isData3DTexture?ge=Math.floor(rt.depth*Dt):ge=1,Re=0,Ce=0,Ee=0}B!==null?(He=B.x,We=B.y,at=B.z):(He=0,We=0,at=0);const Ge=Ue.convert(U.format),ye=Ue.convert(U.type);let pt;U.isData3DTexture?(w.setTexture3D(U,0),pt=P.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(w.setTexture2DArray(U,0),pt=P.TEXTURE_2D_ARRAY):(w.setTexture2D(U,0),pt=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,U.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,U.unpackAlignment);const Xe=P.getParameter(P.UNPACK_ROW_LENGTH),Bt=P.getParameter(P.UNPACK_IMAGE_HEIGHT),kn=P.getParameter(P.UNPACK_SKIP_PIXELS),bt=P.getParameter(P.UNPACK_SKIP_ROWS),Si=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,rt.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,rt.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,Re),P.pixelStorei(P.UNPACK_SKIP_ROWS,Ce),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Ee);const tt=E.isDataArrayTexture||E.isData3DTexture,Pt=U.isDataArrayTexture||U.isData3DTexture;if(E.isDepthTexture){const Dt=xe.get(E),xt=xe.get(U),St=xe.get(Dt.__renderTarget),Ir=xe.get(xt.__renderTarget);Me.bindFramebuffer(P.READ_FRAMEBUFFER,St.__webglFramebuffer),Me.bindFramebuffer(P.DRAW_FRAMEBUFFER,Ir.__webglFramebuffer);for(let wn=0;wn<ge;wn++)tt&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xe.get(E).__webglTexture,I,Ee+wn),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xe.get(U).__webglTexture,J,at+wn)),P.blitFramebuffer(Re,Ce,se,ue,He,We,se,ue,P.DEPTH_BUFFER_BIT,P.NEAREST);Me.bindFramebuffer(P.READ_FRAMEBUFFER,null),Me.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(I!==0||E.isRenderTargetTexture||xe.has(E)){const Dt=xe.get(E),xt=xe.get(U);Me.bindFramebuffer(P.READ_FRAMEBUFFER,Tl),Me.bindFramebuffer(P.DRAW_FRAMEBUFFER,bl);for(let St=0;St<ge;St++)tt?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Dt.__webglTexture,I,Ee+St):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Dt.__webglTexture,I),Pt?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,xt.__webglTexture,J,at+St):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,xt.__webglTexture,J),I!==0?P.blitFramebuffer(Re,Ce,se,ue,He,We,se,ue,P.COLOR_BUFFER_BIT,P.NEAREST):Pt?P.copyTexSubImage3D(pt,J,He,We,at+St,Re,Ce,se,ue):P.copyTexSubImage2D(pt,J,He,We,Re,Ce,se,ue);Me.bindFramebuffer(P.READ_FRAMEBUFFER,null),Me.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else Pt?E.isDataTexture||E.isData3DTexture?P.texSubImage3D(pt,J,He,We,at,se,ue,ge,Ge,ye,rt.data):U.isCompressedArrayTexture?P.compressedTexSubImage3D(pt,J,He,We,at,se,ue,ge,Ge,rt.data):P.texSubImage3D(pt,J,He,We,at,se,ue,ge,Ge,ye,rt):E.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,J,He,We,se,ue,Ge,ye,rt.data):E.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,J,He,We,rt.width,rt.height,Ge,rt.data):P.texSubImage2D(P.TEXTURE_2D,J,He,We,se,ue,Ge,ye,rt);P.pixelStorei(P.UNPACK_ROW_LENGTH,Xe),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Bt),P.pixelStorei(P.UNPACK_SKIP_PIXELS,kn),P.pixelStorei(P.UNPACK_SKIP_ROWS,bt),P.pixelStorei(P.UNPACK_SKIP_IMAGES,Si),J===0&&U.generateMipmaps&&P.generateMipmap(pt),Me.unbindTexture()},this.copyTextureToTexture3D=function(E,U,O=null,B=null,I=0){return E.isTexture!==!0&&(si("WebGLRenderer: copyTextureToTexture3D function signature has changed."),O=arguments[0]||null,B=arguments[1]||null,E=arguments[2],U=arguments[3],I=arguments[4]||0),si('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(E,U,O,B,I)},this.initRenderTarget=function(E){xe.get(E).__webglFramebuffer===void 0&&w.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?w.setTextureCube(E,0):E.isData3DTexture?w.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?w.setTexture2DArray(E,0):w.setTexture2D(E,0),Me.unbindTexture()},this.resetState=function(){b=0,A=0,D=null,Me.reset(),Je.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return cn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}const zp=`
