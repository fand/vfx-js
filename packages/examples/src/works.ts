...
export const works: Work[] = [
    ...
    },
    {
        ...
        author: "AMAGI",
        description:
            "Anamorphic and aperture-diffraction light streaks, switchable between two implementations: instanced sprite splatting and a Kawase directional blur. One knob morphs between a horizontal anamorphic flare and an n-bladed aperture starburst.",
