import{n as e}from"./chunk-BneVvdWh.js";import{a as t,c as n,i as r,n as i,o as a,r as o,s,t as c}from"./utils-75XtCKbd.js";import{n as l,t as u}from"./logo-640w-20p-DamX1-bG.js";import{t as d}from"./preset-B7f9t9lo.js";import{n as f,t as p}from"./jellyfish-B6nQsbyY.js";import{a as m,c as h,i as g,l as _,n as v,o as y,r as b,s as x,t as S}from"./esm-DcO7RLnp.js";function C(){let e=document.createElement(`article`);e.style.cssText=`width: 600px; padding: 32px; background: #fff; color: #202122; font-family: sans-serif; line-height: 1.6; border: 1px solid #a2a9b1;`;let t=`font-family: serif; font-weight: normal; border-bottom: 1px solid #a2a9b1; padding-bottom: 4px; margin-top: 24px;`,n=`margin: 20px 0; text-align: center;`,r=`font-size: 0.85em; color: #54595d; margin-top: 4px;`,i=`width: 100%; height: auto; max-width: 480px; background: #f8f9fa; border: 1px solid #a2a9b1;`;return e.innerHTML=`
    ...
    `,e}function w(e){let t=Math.round(window.innerWidth/2),n=Math.round(window.innerHeight/2),r=Math.min(t,n)*.4,i=0,a=window.setInterval(()=>{let o=i/60*Math.PI*2;e.dispatchEvent(new MouseEvent(`pointermove`,{clientX:t+Math.cos(o)*r,clientY:n+Math.sin(o)*r,bubbles:!0})),i++,i>120&&clearInterval(a)},16)}var T,E,D,O,k,A,j,M,N,P;e((()=>{p(),u(),S(),d(),n(),T={title:`Effect`,parameters:{layout:`fullscreen`}},E=()=>typeof navigator<`u`&&/Chromatic/.test(navigator.userAgent),D={render:()=>{let e=document.createElement(`img`);return e.src=l,e.style.display=`block`,e.style.margin=`40px auto`,e},args:void 0},D.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let n=s(),r=new _({threshold:.2,softness:.1,intensity:5,scatter:1,dither:0,edgeFade:0,pad:50});await n.add(t,{effect:r}),c(`Bloom`,r)},O={render:()=>{let e=document.createElement(`img`);return e.src=f,e},args:void 0},O.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let n=s(),r=new _({threshold:.01,softness:.2,intensity:10,scatter:1,dither:0,edgeFade:.02,pad:200});await n.add(t,{effect:[new g({size:10}),new b({spacing:5}),r]}),c(`CRT Bloom`,r)},k={render:()=>{let e=document.createElement(`img`);return e.src=f,e},args:void 0},k.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let n=s(),r=new h;await n.add(t,{effect:r}),i(`Fluid`,r),w(e)},A={render:()=>{let e=document.createElement(`img`);return e.src=f,e},args:void 0},A.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let n=s(),r={Jellyfish:f,Logo:l},i=null,c=async()=>{let e=i?{...i.params}:{};i&&(n.remove(t),a()),i=new x(e),await n.add(t,{effect:i}),o(`Halftone`,i,{img:t,sources:r,onSrcChange:async e=>{t.src=r[e],await new Promise(e=>{t.onload=()=>e()}),await c()}})};await c()},j={render:()=>{let e=document.createElement(`img`);return e.src=l,e},args:void 0},j.play=async({canvasElement:e})=>{let n=e.querySelector(`img`);await new Promise(e=>{n.onload=()=>e()});let r=s(),i={Jellyfish:f,Logo:l},o=null,c=async()=>{let e=o?{...o.params}:E()?{count:256*256}:{};o&&(r.remove(n),a()),o=new y(e),await r.add(n,{effect:o}),t(`Particle`,o,{img:n,sources:i,onSrcChange:async e=>{n.src=i[e],await new Promise(e=>{n.onload=()=>e()}),await c()}})};await c(),w(e)},M={render:()=>{let e=document.createElement(`img`);return e.src=l,e},args:void 0},M.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=()=>e()}),await new Promise(e=>requestAnimationFrame(()=>e(void 0)));let n=s(),i={Logo:l,Jellyfish:f},o=null,c=async()=>{let e=o?{...o.params}:{};o&&(n.remove(t),a()),await new Promise(e=>requestAnimationFrame(()=>e(void 0))),o=new m(e),await n.add(t,{effect:o}),r(`Particle Explode`,o,{img:t,sources:i,onSrcChange:async e=>{t.src=i[e],await new Promise(e=>{t.onload=()=>e()}),await c()}})};await c()},N={render:e=>{let{src:t,...n}=e,r=s(),i=new v(n);if(t===`Webpage`){let e=document.getElementById(`storybook-root`);e&&(e.style.height=`auto`,e.style.display=`block`);let t=document.createElement(`div`);t.style.display=`flex`,t.style.justifyContent=`center`;let n=C();return t.appendChild(n),r.addHTML(n,{effect:i}),t}let a=document.createElement(`img`);return a.src=t===`Jellyfish`?f:l,r.add(a,{effect:i}),a},args:{src:`Webpage`,cellSize:40,pressRadius:200,press:1,flatCells:!1,seed:0,speed:0,breathe:0,breatheSpeed:0,breatheScale:40,bgColor:`#00000000`},argTypes:{src:{control:{type:`select`},options:[`Logo`,`Jellyfish`,`Webpage`]},cellSize:{control:{type:`range`,min:5,max:200,step:1}},pressRadius:{control:{type:`range`,min:0,max:800,step:10}},press:{control:{type:`range`,min:0,max:1,step:.01}},flatCells:{control:{type:`boolean`}},seed:{control:{type:`range`,min:0,max:1e3,step:1}},speed:{control:{type:`range`,min:0,max:5,step:.05}},breathe:{control:{type:`range`,min:0,max:1,step:.01}},breatheSpeed:{control:{type:`range`,min:0,max:5,step:.05}},breatheScale:{control:{type:`range`,min:10,max:500,step:5}},bgColor:{control:{type:`color`}}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...N.parameters?.docs?.source}}},P=[`bloom`,`crtBloom`,`fluid`,`halftone`,`particle`,`particleExplode`,`voronoi`]}))();export{P as __namedExportsOrder,D as bloom,O as crtBloom,T as default,k as fluid,A as halftone,j as particle,M as particleExplode,N as voronoi};