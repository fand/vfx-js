import{T as g}from"./Timer-D64dUIku.js";import{L as c}from"./preset-B_9u5Dmn.js";import{i as h}from"./utils-BUgq-vrJ.js";import"./vfx-wGJBmbdk.js";const k={title:"Post Effects",render:e=>{const r=new g(e.defaultTime??0,[0,10]);document.body.append(r.element);const n=document.createElement("img");return n.src=e.src??c,h({postEffect:e.postEffect}).add(n,{shader:e.preset,overflow:e.overflow,uniforms:{...e.uniforms??{},time:()=>r.time}}),n},parameters:{layout:"fullscreen"}},x=e=>({args:e}),o=x({src:c,preset:"uvGradient",defaultTime:1,postEffect:{shader:`
