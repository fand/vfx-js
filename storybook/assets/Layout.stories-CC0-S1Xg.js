import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./utils-e3boYsAb.js";import{n as r,r as i,t as a}from"./preset-hB8Fk8QM.js";import{n as o,t as s}from"./Timer-BESiKuhE.js";import{n as c,t as l}from"./jellyfish-CYPChIqL.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{t(),o(),r(),l(),a(),u=`
...
void main() {
    ...
    `,zIndex:e[n],uniforms:{bg:t[n]}})}return r},b={render:y,args:{zIndex:[0,0,0]}},x={render:y,args:{zIndex:[1,3,2]}},S={render:y,args:{zIndex:[3,2,1]}},C={render:()=>{let e=document.createElement(`img`);return e.src=i,n().add(e,{shader:`
        ...
        `,overlay:!0}),e},args:null},w=e=>({render:({wrap:e})=>{let t=document.createElement(`img`);return t.src=i,n().add(t,{shader:u,wrap:e,overflow:200}),t},args:{wrap:e},argTypes:{wrap:{control:{type:`select`},options:[`repeat`,`clamp`,`mirror`]}}}),T=w(`repeat`),E=w(`clamp`),D=w(`mirror`),O={render:({shader:e,autoCrop:t})=>{let r=new s(0,[0,10]);document.body.append(r.element);let i=document.createElement(`img`);return i.src=c,n().add(i,{shader:e,autoCrop:t,overflow:200,uniforms:{time:()=>r.time}}),i},args:{shader:`rainbow`,autoCrop:!0}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: ({
    padding
  }) => {
