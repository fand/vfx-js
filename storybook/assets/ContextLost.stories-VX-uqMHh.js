import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-BqC3Il7d.js";import{t as r}from"./client-V4imcPTF.js";import{d as i,u as a}from"./utils-Cw42DJk4.js";import{n as o,t as s}from"./logo-640w-20p-DamX1-bG.js";import{t as c}from"./preset-B7f9t9lo.js";import{i as l,l as u,o as d,s as f}from"./react-Bb-LS3db.js";function p(){let e=m();return e?(e.getContext(`webgl2`)??e.getContext(`webgl`))?.getExtension(`WEBGL_lose_context`)??null:null}function m(){return document.querySelector(`canvas[style*="pointer-events"]`)}function h(e,t){return new Promise(n=>{if(!e){n();return}e.addEventListener(t,()=>requestAnimationFrame(()=>n()),{once:!0})})}function g(){let e=(0,v.useContext)(u),t=(0,v.useRef)(null),n=(0,v.useRef)(null),r=(0,v.useRef)(0),i=(0,v.useCallback)(()=>{n.current||=p()},[]),a=(0,v.useCallback)(()=>{e&&(e.render(),r.current+=.1)},[e]),s=(0,v.useCallback)(()=>{i(),n.current?.loseContext(),t.current&&(t.current.textContent=`Status: context lost`)},[i]),c=(0,v.useCallback)(()=>{n.current?.restoreContext(),t.current&&(t.current.textContent=`Status: context restored`),r.current=0},[]),l=v.createElement;return l(`div`,null,l(`div`,{style:{display:`flex`,gap:`10px`}},l(`span`,{ref:t,style:{color:`white`}},`Status: rendering`),l(`button`,{onClick:a},`Draw`),l(`button`,{onClick:s},`Force Context Lost`),l(`button`,{onClick:c},`Force Context Restore`)),l(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`20px`}},l(f,{src:o,shader:`rainbow`,uniforms:{time:()=>r.current}}),l(f,{src:o,shader:b,backbuffer:!0,uniforms:{time:()=>r.current}})))}function _(){let e=v.createElement;return e(d,{autoplay:!1},e(g,null))}var v,y,b,x,S,C,w,T;t((()=>{v=e(n(),1),y=e(r(),1),l(),s(),i(),c(),b=`
