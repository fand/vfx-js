import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-BqC3Il7d.js";import{t as r}from"./client-V4imcPTF.js";import{d as i,u as a}from"./utils-Cw42DJk4.js";import{c as o,i as s,o as c}from"./react-Bb-LS3db.js";import{n as l,t as u}from"./Timer-DkrwUFAC.js";function d(e,t=`rainbow`){let n=new u(0,[0,10]);document.body.append(n.element);let r=a();return r.addHTML(e,{shader:t,uniforms:{time:()=>n.time}}),r}function f(){let e=document.getElementById(`storybook-root`);e.style.height=`auto`,e.style.display=`block`}var p,m,h,g,_,v,y,b,x,S,C,w,T;t((()=>{p=e(n(),1),m=e(r(),1),s(),l(),i(),h=(e,t)=>e.querySelector(t),g=`
...
`,_={title:`Html In Canvas`,parameters:{layout:`fullscreen`,chromatic:{disableSnapshot:!0}}},v={render:()=>{f();let e=document.createElement(`div`);e.style.cssText=`padding:96px 128px 128px; font-family:sans-serif; color:white`;let t=document.createElement(`div`);return t.id=`add-html-target`,t.innerHTML=`
  ...
  play: async ({
    ...
    }, h("h2", null, "VFXCanvas (@vfx-js/react)"), h("p", {
      style: {
        fontSize: "1.2rem",
        lineHeight: 1.6,
        maxWidth: 600
