import{n as e}from"./chunk-BneVvdWh.js";import{a as t,c as n,i as r,l as i,n as a,o,r as s,s as c,t as l}from"./utils-Baz7DLhu.js";import{n as u,t as d}from"./logo-640w-20p-DamX1-bG.js";import{t as f}from"./preset-B7f9t9lo.js";import{n as p,t as m}from"./jellyfish-B6nQsbyY.js";import{a as h,c as g,i as _,l as v,n as y,o as b,r as x,s as S,t as C,u as w}from"./esm-BmhOue_T.js";function T(){let e=document.createElement(`article`);e.style.cssText=`width: 600px; padding: 32px; background: #fff; color: #202122; font-family: sans-serif; line-height: 1.6; border: 1px solid #a2a9b1;`;let t=`font-family: serif; font-weight: normal; border-bottom: 1px solid #a2a9b1; padding-bottom: 4px; margin-top: 24px;`,n=`margin: 20px 0; text-align: center;`,r=`font-size: 0.85em; color: #54595d; margin-top: 4px;`,i=`width: 100%; height: auto; max-width: 480px; background: #f8f9fa; border: 1px solid #a2a9b1;`;return e.innerHTML=`
    ...
    `,e}function E(e){let t=Math.round(window.innerWidth/2),n=Math.round(window.innerHeight/2),r=Math.min(t,n)*.4,i=0,a=window.setInterval(()=>{let o=i/60*Math.PI*2;e.dispatchEvent(new MouseEvent(`pointermove`,{clientX:t+Math.cos(o)*r,clientY:n+Math.sin(o)*r,bubbles:!0})),i++,i>120&&clearInterval(a)},16)}var D,O,k,A,j,M,N,P,F,I,L;e((()=>{m(),d(),C(),f(),i(),D={title:`Effect`,parameters:{layout:`fullscreen`}},O=()=>typeof navigator<`u`&&/Chromatic/.test(navigator.userAgent),k={render:()=>{let e=document.createElement(`img`);return e.src=u,e.style.display=`block`,e.style.margin=`40px auto`,e},args:void 0},k.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let r=n(),i=new w({threshold:.2,softness:.1,intensity:5,scatter:1,dither:0,edgeFade:0,pad:50});await r.add(t,{effect:i}),l(`Bloom`,i)},A={render:()=>{let e=document.createElement(`img`);return e.src=p,e},args:void 0},A.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let r=n(),i=new w({threshold:.01,softness:.2,intensity:10,scatter:1,dither:0,edgeFade:.02,pad:200});await r.add(t,{effect:[new h({size:10}),new x({spacing:5}),i]}),l(`CRT Bloom`,i)},j={render:()=>{let e=document.createElement(`img`);return e.src=p,e},args:void 0,parameters:{chromatic:{disableSnapshot:!0}}},j.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let r=n(),i=new _({range:[.5,1],direction:`up`,angle:30});await r.add(t,{effect:i}),o(`Pixel Sort`,i)},M={render:()=>{let e=document.createElement(`img`);return e.src=p,e},args:void 0},M.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let r=n(),i=new v;await r.add(t,{effect:i}),a(`Fluid`,i),E(e)},N={render:()=>{let e=document.createElement(`img`);return e.src=p,e},args:void 0},N.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=e});let r=n(),i={Jellyfish:p,Logo:u},a=null,o=async()=>{let e=a?{...a.params}:{};a&&(r.remove(t),c()),a=new g(e),await r.add(t,{effect:a}),s(`Halftone`,a,{img:t,sources:i,onSrcChange:async e=>{t.src=i[e],await new Promise(e=>{t.onload=()=>e()}),await o()}})};await o()},P={render:()=>{let e=document.createElement(`img`);return e.src=u,e},args:void 0},P.play=async({canvasElement:e})=>{let r=e.querySelector(`img`);await new Promise(e=>{r.onload=()=>e()});let i=n(),a={Jellyfish:p,Logo:u},o=null,s=async()=>{let e=o?{...o.params}:O()?{count:256*256}:{};o&&(i.remove(r),c()),o=new S(e),await i.add(r,{effect:o}),t(`Particle`,o,{img:r,sources:a,onSrcChange:async e=>{r.src=a[e],await new Promise(e=>{r.onload=()=>e()}),await s()}})};await s(),E(e)},F={render:()=>{let e=document.createElement(`img`);return e.src=u,e},args:void 0},F.play=async({canvasElement:e})=>{let t=e.querySelector(`img`);await new Promise(e=>{t.onload=()=>e()}),await new Promise(e=>requestAnimationFrame(()=>e(void 0)));let i=n(),a={Logo:u,Jellyfish:p},o=null,s=async()=>{let e=o?{...o.params}:{};o&&(i.remove(t),c()),await new Promise(e=>requestAnimationFrame(()=>e(void 0))),o=new b(e),await i.add(t,{effect:o}),r(`Particle Explode`,o,{img:t,sources:a,onSrcChange:async e=>{t.src=a[e],await new Promise(e=>{t.onload=()=>e()}),await s()}})};await s()},I={render:e=>{let{src:t,...r}=e,i=n(),a=new y(r);if(t===`Webpage`){let e=document.getElementById(`storybook-root`);e&&(e.style.height=`auto`,e.style.display=`block`);let t=document.createElement(`div`);t.style.display=`flex`,t.style.justifyContent=`center`;let n=T();return t.appendChild(n),i.addHTML(n,{effect:a}),t}let o=document.createElement(`img`);return o.src=t===`Jellyfish`?p:u,i.add(o,{effect:a}),o},args:{src:`Webpage`,cellSize:40,pressRadius:200,press:1,flatCells:!1,seed:0,speed:0,breathe:0,breatheSpeed:0,breatheScale:40,bgColor:`#00000000`},argTypes:{src:{control:{type:`select`},options:[`Logo`,`Jellyfish`,`Webpage`]},cellSize:{control:{type:`range`,min:5,max:200,step:1}},pressRadius:{control:{type:`range`,min:0,max:800,step:10}},press:{control:{type:`range`,min:0,max:1,step:.01}},flatCells:{control:{type:`boolean`}},seed:{control:{type:`range`,min:0,max:1e3,step:1}},speed:{control:{type:`range`,min:0,max:5,step:.05}},breathe:{control:{type:`range`,min:0,max:1,step:.01}},breatheSpeed:{control:{type:`range`,min:0,max:5,step:.05}},breatheScale:{control:{type:`range`,min:10,max:500,step:5}},bgColor:{control:{type:`color`}}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...I.parameters?.docs?.source}}},L=[`bloom`,`crtBloom`,`pixelSort`,`fluid`,`halftone`,`particle`,`particleExplode`,`voronoi`]}))();export{L as __namedExportsOrder,k as bloom,A as crtBloom,D as default,M as fluid,N as halftone,P as particle,F as particleExplode,j as pixelSort,I as voronoi};