import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-CnPKFcMr.js";import{t as r}from"./client-D465T0FV.js";import{d as i,f as a}from"./utils-BtfdcQuE.js";import{d as o,i as s,s as c}from"./react-CAIqA2hN.js";import{n as l,t as u}from"./Timer-zmWoh-G8.js";function d(e,t=`rainbow`){let n=new u(0,[0,10]);document.body.append(n.element);let r=i();return r.addHTML(e,{shader:t,uniforms:{time:()=>n.time}}),r}function f(){let e=document.getElementById(`storybook-root`);e.style.height=`auto`,e.style.display=`block`}var p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{p=t(n(),1),m=t(r(),1),s(),l(),a(),h=(e,t)=>e.querySelector(t),g=`
