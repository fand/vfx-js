import{n as e}from"./chunk-BneVvdWh.js";import{n as t,t as n}from"./utils-e3boYsAb.js";import{n as r,r as i,t as a}from"./preset-hB8Fk8QM.js";import{n as o,t as s}from"./jellyfish-CYPChIqL.js";function c(e){return`
...
`}));function x(e){let t=0,n=0,r=0,i=()=>[n,r],a=e.simResolution,o=window.innerWidth/window.innerHeight;return{passes:u({simSize:o>1?[Math.round(a*o),a]:[a,Math.round(a/o)],mouseDelta:i,time:()=>t,pressureIterations:e.pressureIterations,curlStrength:e.curlStrength,velocityDissipation:e.velocityDissipation,densityDissipation:e.densityDissipation,splatForce:e.splatForce,splatRadius:e.splatRadius,dyeSplatRadius:e.dyeSplatRadius,dyeSplatIntensity:e.dyeSplatIntensity,showDye:e.showDye}),getTime:()=>t,setTime:e=>{t=e},setDelta:(e,t)=>{n=e,r=t}}}function S(e,t,n){let r=Math.round(window.innerWidth/2),i=Math.round(window.innerHeight/2);for(let e=0;e<100;e++){let a=e/100*Math.PI*2;n.setDelta(Math.cos(a)*15,Math.sin(a)*15),window.dispatchEvent(new MouseEvent(`pointermove`,{clientX:r+Math.cos(a)*100,clientY:i-Math.sin(a)*100})),n.setTime(e*.016),t.render()}e.addEventListener(`click`,()=>{let e=-1,r=-1,i;window.addEventListener(`pointermove`,t=>{let a=t.clientX,o=window.innerHeight-t.clientY;e>=0&&n.setDelta(a-e,o-r),e=a,r=o,clearTimeout(i),i=window.setTimeout(()=>n.setDelta(0,0),50)}),t.play()},{once:!0})}var C,w,T,E,D,O;e((()=>{s(),r(),b(),t(),a(),C={simResolution:{control:{type:`range`,min:32,max:512,step:32}},pressureIterations:{control:{type:`range`,min:1,max:40,step:1}},curlStrength:{control:{type:`range`,min:0,max:100,step:1}},velocityDissipation:{control:{type:`range`,min:0,max:5,step:.05}},densityDissipation:{control:{type:`range`,min:0,max:5,step:.05}},splatForce:{control:{type:`range`,min:100,max:2e4,step:100}},splatRadius:{control:{type:`range`,min:1e-4,max:.01,step:1e-4}},dyeSplatRadius:{control:{type:`range`,min:1e-4,max:.01,step:1e-4}},dyeSplatIntensity:{control:{type:`range`,min:.001,max:.03,step:.001}},showDye:{control:`boolean`}},w={simResolution:128,pressureIterations:1,curlStrength:13,velocityDissipation:.6,densityDissipation:.65,splatForce:6e3,splatRadius:.002,dyeSplatRadius:.001,dyeSplatIntensity:.005,showDye:!1},T={title:`Multipass`,parameters:{layout:`fullscreen`}},E={args:{...w},argTypes:C,render:()=>{let e=document.createElement(`img`);return e.src=i,e},play:async({canvasElement:e,args:t})=>{let r=e.querySelector(`img`);await new Promise(e=>{r.onload=e});let i=x(t),a=n({autoplay:!1,postEffect:i.passes});await a.add(r,{shader:`uvGradient`}),S(e,a,i)},parameters:{layout:`fullscreen`}},D={args:{...w},argTypes:C,render:()=>{let e=document.createElement(`img`);return e.src=o,e},play:async({canvasElement:e,args:t})=>{let r=e.querySelector(`img`);await new Promise(e=>{r.onload=e});let i=x(t),a=n({autoplay:!1});await a.add(r,{shader:i.passes}),S(e,a,i)},parameters:{layout:`fullscreen`}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    ...defaultFluidArgs
  },
