...
`,jo={"sine wave":0,twist:1,ripple:2},Mo={type:`twist`,amplitude:3,frequency:1,centerX:.5,centerY:.5,speed:0},No=class{constructor(e={}){this.params={...Mo,...e}}setParams(e){Object.assign(this.params,e)}render(e){let t=this.params;e.draw({frag:Ao,uniforms:{src:e.src,center:[t.centerX,t.centerY],resolution:[e.dims.element[0]||1,e.dims.element[1]||1],mode:jo[t.type]??0,amp:t.amplitude,freq:t.frequency,time:e.time*t.speed},target:e.target})}}})),Fo=e((()=>{se(),be(),Pe(),Re(),Ge(),St(),Dt(),jt(),Qt(),nn(),un(),gn(),bn(),lr(),jr(),Ni(),ea(),oa(),ua(),ma(),Ba(),Wa(),Ja(),Qa(),no(),oo(),uo(),go(),bo(),wo(),ko(),Po()}));export{Dt as $,aa as A,yn as B,Wa as C,ma as D,pa as E,Ni as F,un as G,hn as H,Ar as I,Zt as J,tn as K,jr as L,$i as M,ea as N,la as O,Mi as P,Et as Q,cr as R,Ua as S,Ba as T,gn as U,bn as V,ln as W,At as X,Qt as Y,jt as Z,no as _,ko as a,Re as at,qa as b,yo as c,ye as ct,go as d,se as dt,xt as et,lo as f,to as g,oo as h,Oo as i,Le as it,oa as j,ua as k,bo as l,be as lt,ao as m,No as n,We as nt,Co as o,Ne as ot,uo as p,nn as q,Po as r,Ge as rt,wo as s,Pe as st,Fo as t,St as tt,ho as u,oe as ut,Za as v,za as w,Ja as x,Qa as y,lr as z};