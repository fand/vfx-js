...
`,u={render:()=>{let e=document.createElement(`img`);return e.src=r,e},play:async({canvasElement:e})=>{let n=e.querySelector(`img`);n.complete||await new Promise(e=>{n.onload=e});let r=1,i=t({autoplay:!1,postEffect:{shader:l,persistent:!0,uniforms:{time:()=>r}}});await i.add(n,{shader:`uvGradient`,uniforms:{time:()=>r}});for(let e=0;e<60;e++)r=1+e*.016,i.render()},parameters:{layout:`fullscreen`}},d={render:()=>{let e=new s(0,[0,10]);document.body.append(e.element);let n={time:()=>e.time},i=document.createElement(`div`),a=document.createElement(`img`);a.src=r,a.width=300;let o=a.cloneNode(),c=a.cloneNode();i.appendChild(a),i.appendChild(o),i.appendChild(c);let l=t({postEffect:{shader:`invert`}});return l.add(a,{shader:`rgbShift`,uniforms:n}),l.add(o,{shader:`sinewave`,uniforms:n}),l.add(c,{shader:`uvGradient`,uniforms:n}),i}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  render: () => {
